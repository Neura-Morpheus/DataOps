...
package adventure_project.customeraddress_0_1;
...
/**
 * Job: CustomerAddress Purpose: ETL area RAW<br>
 * Description: Carga de dados tabela CustomerAddress para RAW <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class CustomerAddress implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "CustomerAddress";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				CustomerAddress.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(CustomerAddress.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class saida_CustomerAddressStruct implements routines.system.IPersistableRow<saida_CustomerAddressStruct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_CustomerAddress = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_CustomerAddress = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADVENTURE_PROJECT_CustomerAddress.length) {
				if(length < 1024 && commonByteArray_ADVENTURE_PROJECT_CustomerAddress.length == 0) {
   					commonByteArray_ADVENTURE_PROJECT_CustomerAddress = new byte[1024];
				} else {
   					commonByteArray_ADVENTURE_PROJECT_CustomerAddress = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADVENTURE_PROJECT_CustomerAddress, 0, length);
			strReturn = new String(commonByteArray_ADVENTURE_PROJECT_CustomerAddress, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADVENTURE_PROJECT_CustomerAddress) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/RAW/CustomerAddress.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:sLhtksbCxbfiROyJ0SQh7cXESFO3cnX8fOGiLrQ8bPx6I/GmNw==");
		    ...
		    String dbquery_tDBInput_1 = "SELECT SalesLT.CustomerAddress.CustomerID,\n		SalesLT.CustomerAddress.AddressID,\n		SalesLT.CustomerAddress.AddressType,\n"
+"		SalesLT.CustomerAddress.rowguid,\n		SalesLT.CustomerAddress.ModifiedDate\nFROM	SalesLT.CustomerAddress";
            ...
            row1.AddressID = rs_tDBInput_1.getInt(2);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
							if(colQtyInRs_tDBInput_1 < 3) {
								row1.AddressType = null;
							} else {
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.AddressType = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.AddressType = tmpContent_tDBInput_1;
                }
            } else {
                row1.AddressType = null;
            }
...
saida_CustomerAddress_tmp.CustomerID = row1.CustomerID;
saida_CustomerAddress_tmp.AddressID = row1.AddressID;
saida_CustomerAddress_tmp.AddressType = row1.AddressType;
saida_CustomerAddress_tmp.rowguid = row1.rowguid;
saida_CustomerAddress_tmp.ModifiedDate = row1.ModifiedDate;
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_1=new String[5];
                            rowtFileOutputDelimited_1[0]=saida_CustomerAddress.CustomerID == null ? null : String.valueOf(saida_CustomerAddress.CustomerID);
                            rowtFileOutputDelimited_1[1]=saida_CustomerAddress.AddressID == null ? null : String.valueOf(saida_CustomerAddress.AddressID);
                            rowtFileOutputDelimited_1[2]=saida_CustomerAddress.AddressType == null ? null : saida_CustomerAddress.AddressType;
                            rowtFileOutputDelimited_1[3]=saida_CustomerAddress.rowguid == null ? null : String.valueOf(saida_CustomerAddress.rowguid);
                            rowtFileOutputDelimited_1[4]=saida_CustomerAddress.ModifiedDate == null ? null : FormatterUtils.format_Date(saida_CustomerAddress.ModifiedDate, "dd-MM-yyyy");
 ...
 */
    ...
    public static void main(String[] args){
        final CustomerAddress CustomerAddressClass = new CustomerAddress();

        int exitCode = CustomerAddressClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = CustomerAddress.class.getClassLoader().getResourceAsStream("adventure_project/customeraddress_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = CustomerAddress.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : CustomerAddress");
        }
...
/************************************************************************************************
 *     57683 characters generated by Talend Open Studio for Big Data 
