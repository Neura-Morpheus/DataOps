...
package adventure_project.salesorderheader_0_1;
...
/**
 * Job: SalesOrderHeader Purpose: ETL area RAW<br>
 * Description: Carga de dados tabela SalesOrderHeader area RAW <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class SalesOrderHeader implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SalesOrderHeader";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SalesOrderHeader.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SalesOrderHeader.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class saida_SalesOrderHeaderStruct implements routines.system.IPersistableRow<saida_SalesOrderHeaderStruct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_SalesOrderHeader = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_SalesOrderHeader = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADVENTURE_PROJECT_SalesOrderHeader.length) {
				if(length < 1024 && commonByteArray_ADVENTURE_PROJECT_SalesOrderHeader.length == 0) {
   					commonByteArray_ADVENTURE_PROJECT_SalesOrderHeader = new byte[1024];
				} else {
   					commonByteArray_ADVENTURE_PROJECT_SalesOrderHeader = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADVENTURE_PROJECT_SalesOrderHeader, 0, length);
			strReturn = new String(commonByteArray_ADVENTURE_PROJECT_SalesOrderHeader, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADVENTURE_PROJECT_SalesOrderHeader) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/RAW/SalesOrderHeader.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:bHEg54QQanYMg0HCqoVgE52uDq/ZA5EmxSeuZEVRYT0f4X2D9A==");
...
+"rowguid,\n		SalesLT.SalesOrderHeader.ModifiedDate\nFROM	SalesLT.SalesOrderHeader";
            ...
            row1.SubTotal = rs_tDBInput_1.getFloat(16);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.TaxAmt = rs_tDBInput_1.getFloat(17);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.Freight = rs_tDBInput_1.getFloat(18);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
            ...
            row1.TotalDue = rs_tDBInput_1.getFloat(19);
            if(rs_tDBInput_1.wasNull()){
                    throw new RuntimeException("Null value in non-Nullable column");
            }
		                    }
...
saida_SalesOrderHeader_tmp.rowguid = row1.rowguid;
saida_SalesOrderHeader_tmp.ModifiedDate = row1.ModifiedDate;
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_1=new String[22];
                            rowtFileOutputDelimited_1[0]=saida_SalesOrderHeader.SalesOrderID == null ? null : String.valueOf(saida_SalesOrderHeader.SalesOrderID);
                            ...
                            rowtFileOutputDelimited_1[20]=saida_SalesOrderHeader.rowguid == null ? null : String.valueOf(saida_SalesOrderHeader.rowguid);
                            rowtFileOutputDelimited_1[21]=saida_SalesOrderHeader.ModifiedDate == null ? null : FormatterUtils.format_Date(saida_SalesOrderHeader.ModifiedDate, "dd-MM-yyyy");
 ...
 */
    ...
    public static void main(String[] args){
        final SalesOrderHeader SalesOrderHeaderClass = new SalesOrderHeader();

        int exitCode = SalesOrderHeaderClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SalesOrderHeader.class.getClassLoader().getResourceAsStream("adventure_project/salesorderheader_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SalesOrderHeader.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SalesOrderHeader");
        }
...
/************************************************************************************************
 *     83695 characters generated by Talend Open Studio for Big Data 
 *     on the 8 de Julho de 2021 1h41min24s BRT
 ************************************************************************************************/