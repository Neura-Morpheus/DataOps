...
package adventure_project.address_0_1;
...
/**
 * Job: Address Purpose: ETL area RAW<br>
 * Description: Carga de dados tabela address para area RAW <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Address implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Address";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Address.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class saida_addressStruct implements routines.system.IPersistableRow<saida_addressStruct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_Address = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_Address = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADVENTURE_PROJECT_Address.length) {
				if(length < 1024 && commonByteArray_ADVENTURE_PROJECT_Address.length == 0) {
   					commonByteArray_ADVENTURE_PROJECT_Address = new byte[1024];
				} else {
   					commonByteArray_ADVENTURE_PROJECT_Address = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADVENTURE_PROJECT_Address, 0, length);
			strReturn = new String(commonByteArray_ADVENTURE_PROJECT_Address, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADVENTURE_PROJECT_Address) {
     ...
     * Compare keys
     */
    public int compareTo(saida_addressStruct other) {
...
saida_addressStruct saida_address = new saida_addressStruct();
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"saida_address");
					}
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/RAW/Address.csv")).getAbsolutePath().replace("\\","/");
            ...
            csvSettings_tFileOutputDelimited_1.setEscapeAndTextEnclosure("\"","\"");
                    ...
                    if(!csvSettings_tFileOutputDelimited_1.isUseCRLFRecordDelimiter() && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\r' && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\n') {
                        ...
                        if(filetFileOutputDelimited_1.length()==0){
                                    headColutFileOutputDelimited_1[0]="AddressID";
                                    headColutFileOutputDelimited_1[1]="AddressLine1";
                                    headColutFileOutputDelimited_1[2]="AddressLine2";
                                    headColutFileOutputDelimited_1[3]="City";
                                    headColutFileOutputDelimited_1[4]="StateProvince";
                                    headColutFileOutputDelimited_1[5]="CountryRegion";
                                    headColutFileOutputDelimited_1[6]="PostalCode";
...
saida_addressStruct saida_address_tmp = new saida_addressStruct();
// ###############################
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:tKk9fcz5nSEandU76QyBP+x1H5k1+FJ6JNzi1yQnGvYCUnmXZA==");
...
// # Output table : 'saida_address'
saida_address_tmp.AddressID = row1.AddressID;
saida_address_tmp.AddressLine1 = row1.AddressLine1;
saida_address_tmp.AddressLine2 = row1.AddressLine2;
saida_address_tmp.City = row1.City;
saida_address_tmp.StateProvince = row1.StateProvince;
saida_address_tmp.CountryRegion = row1.CountryRegion;
saida_address_tmp.PostalCode = row1.PostalCode;
saida_address_tmp.rowguid = row1.rowguid;
saida_address_tmp.ModifiedDate = row1.ModifiedDate;
saida_address = saida_address_tmp;
// ###############################
 ...
 */
// Start of branch "saida_address"
if(saida_address != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"saida_address");
					}
					


                        String[] rowtFileOutputDelimited_1=new String[9];
                            rowtFileOutputDelimited_1[0]=saida_address.AddressID == null ? null : String.valueOf(saida_address.AddressID);
                            rowtFileOutputDelimited_1[1]=saida_address.AddressLine1 == null ? null : saida_address.AddressLine1;
                            rowtFileOutputDelimited_1[2]=saida_address.AddressLine2 == null ? null : saida_address.AddressLine2;
                            rowtFileOutputDelimited_1[3]=saida_address.City == null ? null : saida_address.City;
                            rowtFileOutputDelimited_1[4]=saida_address.StateProvince == null ? null : saida_address.StateProvince;
                            rowtFileOutputDelimited_1[5]=saida_address.CountryRegion == null ? null : saida_address.CountryRegion;
                            rowtFileOutputDelimited_1[6]=saida_address.PostalCode == null ? null : saida_address.PostalCode;
                            rowtFileOutputDelimited_1[7]=saida_address.rowguid == null ? null : String.valueOf(saida_address.rowguid);
                            rowtFileOutputDelimited_1[8]=saida_address.ModifiedDate == null ? null : FormatterUtils.format_Date(saida_address.ModifiedDate, "dd-MM-yyyy");
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
		...
		resourceMap.put("finish_tFileOutputDelimited_1", true);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"saida_address");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Address AddressClass = new Address();

        int exitCode = AddressClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Address.class.getClassLoader().getResourceAsStream("adventure_project/address_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Address.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Address");
        }
...
/************************************************************************************************
 *     63434 characters generated by Talend Open Studio for Big Data 
