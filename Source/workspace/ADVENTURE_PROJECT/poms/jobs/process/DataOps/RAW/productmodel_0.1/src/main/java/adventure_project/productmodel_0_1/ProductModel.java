...
package adventure_project.productmodel_0_1;
...
/**
 * Job: ProductModel Purpose: ETL area RAW<br>
 * Description: Carga de dados ProductModel area RAW <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class ProductModel implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "ProductModel";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProductModel.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class saida_ProductModelStruct implements routines.system.IPersistableRow<saida_ProductModelStruct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_ProductModel = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_ProductModel = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADVENTURE_PROJECT_ProductModel.length) {
				if(length < 1024 && commonByteArray_ADVENTURE_PROJECT_ProductModel.length == 0) {
   					commonByteArray_ADVENTURE_PROJECT_ProductModel = new byte[1024];
				} else {
   					commonByteArray_ADVENTURE_PROJECT_ProductModel = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADVENTURE_PROJECT_ProductModel, 0, length);
			strReturn = new String(commonByteArray_ADVENTURE_PROJECT_ProductModel, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADVENTURE_PROJECT_ProductModel) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/RAW/ProductModel.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword("enc:routine.encryption.key.v1:VIINNfQ0QZK76Xg/DxGMLtRkYMmpBSjSjUTNBGD/0iRhpRuRJA==");
		    ...
		    String dbquery_tDBInput_1 = "SELECT SalesLT.ProductModel.ProductModelID,\n		SalesLT.ProductModel.Name,\n		SalesLT.ProductModel.CatalogDescription,\n		S"
+"alesLT.ProductModel.rowguid,\n		SalesLT.ProductModel.ModifiedDate\nFROM	SalesLT.ProductModel";
            ...
            if(tmpContent_tDBInput_1 != null) {
            	if (talendToDBList_tDBInput_1 .contains(rsmd_tDBInput_1.getColumnTypeName(3).toUpperCase(java.util.Locale.ENGLISH))) {
            		row1.CatalogDescription = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
            	} else {
                	row1.CatalogDescription = tmpContent_tDBInput_1;
                }
            } else {
                row1.CatalogDescription = null;
            }
...
saida_ProductModel_tmp.CatalogDescription = row1.CatalogDescription;
saida_ProductModel_tmp.rowguid = row1.rowguid;
saida_ProductModel_tmp.ModifiedDate = row1.ModifiedDate;
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_1=new String[5];
                            ...
                            rowtFileOutputDelimited_1[3]=saida_ProductModel.rowguid == null ? null : String.valueOf(saida_ProductModel.rowguid);
                            rowtFileOutputDelimited_1[4]=saida_ProductModel.ModifiedDate == null ? null : FormatterUtils.format_Date(saida_ProductModel.ModifiedDate, "dd-MM-yyyy");
 ...
 */
    ...
    public static void main(String[] args){
        final ProductModel ProductModelClass = new ProductModel();

        int exitCode = ProductModelClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProductModel.class.getClassLoader().getResourceAsStream("adventure_project/productmodel_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ProductModel.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProductModel");
        }
...
/************************************************************************************************
 *     57850 characters generated by Talend Open Studio for Big Data 
