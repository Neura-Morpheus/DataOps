...
package adventure_project.rel_semanal_vendas_0_1;
...
/**
 * Job: REL_Semanal_Vendas Purpose: Relatorio de Vendas semanais<br>
 ...
 * @status
 */
public class REL_Semanal_Vendas implements TalendJob {
	...
	private final String jobName = "REL_Semanal_Vendas";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					REL_Semanal_Vendas.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(REL_Semanal_Vendas.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_REL_Semanal_Vendas = new byte[0];
		static byte[] commonByteArray_ADVENTURE_PROJECT_REL_Semanal_Vendas = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ADVENTURE_PROJECT_REL_Semanal_Vendas) {
					...
					while (limittFileInputDelimited_1 != 0 && csvReadertFileInputDelimited_1 != null
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									if (rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row1.SalesOrderID = ParserUtils.parseTo_Integer(
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									if (rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row1.SalesOrderDetailID = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);

										} catch (java.lang.Exception ex_tFileInputDelimited_1) {
											rowstate_tFileInputDelimited_1.setException(new RuntimeException(String
													.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
															"SalesOrderDetailID", "row1",
															rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1],
															ex_tFileInputDelimited_1),
													ex_tFileInputDelimited_1));
										}
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									if (rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row1.SalesSK = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									if (rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row1.OrderQty = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
								...
								if (columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length) {
									...
									if (rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										try {
											...
											row1.LineTotal = ParserUtils.parseTo_Float(
													rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if (row1 != null) {
							...
							if (runTrace.isPause()) {
								...
								runTraceData.put("SalesOrderDetailID", String.valueOf(row1.SalesOrderDetailID));
								...
								runTraceData.put("SalesSK", String.valueOf(row1.SalesSK));

								runTraceData.put("OrderQty", String.valueOf(row1.OrderQty));

								runTraceData.put("LineTotal", String.valueOf(row1.LineTotal));
...
// Start of branch "row1"
						if (row1 != null) {
							...
							if (!rejectedInnerJoin_tMap_1) { // G_TM_M_020
								...
								row2HashKey.OrderDate = row1.OrderDate == null ? null
										: new java.util.Date(row1.OrderDate.getTime());
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// outputs:()
				// linked node: tMap_1 - inputs:(row1,row2,row6,row4,row5,row3) outputs:()
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									if (rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row2.OrderDate = ParserUtils.parseTo_Date(
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									if (rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row2.Ano = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									if (rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row2.Mes = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
								...
								if (columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length) {
									...
									if (rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row2.SemanaAno = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
								...
								if (columnIndexWithD_tFileInputDelimited_3 < rowtFileInputDelimited_3.length) {
									...
									if (rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3].length() > 0) {
										try {
											...
											row6.SalesOrderID = ParserUtils.parseTo_Integer(
								...
								if (columnIndexWithD_tFileInputDelimited_3 < rowtFileInputDelimited_3.length) {
									...
									if (rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3].length() > 0) {
										try {
											...
											row6.RevisionNumber = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3]);
								...
								if (columnIndexWithD_tFileInputDelimited_3 < rowtFileInputDelimited_3.length) {
									...
									if (rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3].length() > 0) {
										try {
											...
											row6.OrderDate = ParserUtils.parseTo_Date(
													rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3],
													"dd-MM-yyyy");
								...
								if (columnIndexWithD_tFileInputDelimited_3 < rowtFileInputDelimited_3.length) {
									...
									if (rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3].length() > 0) {
										try {
											...
											row6.DueDate = ParserUtils.parseTo_Date(
													rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3],
													"dd-MM-yyyy");
								...
								if (columnIndexWithD_tFileInputDelimited_3 < rowtFileInputDelimited_3.length) {
									...
									if (rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3].length() > 0) {
										try {
											...
											row6.ShipDate = ParserUtils.parseTo_Date(
													rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3],
													"dd-MM-yyyy");
								...
								if (columnIndexWithD_tFileInputDelimited_3 < rowtFileInputDelimited_3.length) {
									...
									if (rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3].length() > 0) {
										try {
											...
											row6.Status = ParserUtils.parseTo_Short(
													rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3]);
								...
								if (columnIndexWithD_tFileInputDelimited_3 < rowtFileInputDelimited_3.length) {
									...
									if (rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3].length() > 0) {
										try {
											...
											row6.OnlineOrderFlag = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3]);

										} catch (java.lang.Exception ex_tFileInputDelimited_3) {
											rowstate_tFileInputDelimited_3.setException(new RuntimeException(String
													.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
															"OnlineOrderFlag", "row6",
															rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3],
															ex_tFileInputDelimited_3),
													ex_tFileInputDelimited_3));
										}
								...
								if (columnIndexWithD_tFileInputDelimited_3 < rowtFileInputDelimited_3.length) {
									...
									if (rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3].length() > 0) {
										try {
											...
											row6.ShipToAddressID = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3]);

										} catch (java.lang.Exception ex_tFileInputDelimited_3) {
											rowstate_tFileInputDelimited_3.setException(new RuntimeException(String
													.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
															"ShipToAddressID", "row6",
															rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3],
															ex_tFileInputDelimited_3),
													ex_tFileInputDelimited_3));
										}
								...
								if (columnIndexWithD_tFileInputDelimited_3 < rowtFileInputDelimited_3.length) {
									...
									if (rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3].length() > 0) {
										try {
											...
											row6.BillToAddressID = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3]);

										} catch (java.lang.Exception ex_tFileInputDelimited_3) {
											rowstate_tFileInputDelimited_3.setException(new RuntimeException(String
													.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
															"BillToAddressID", "row6",
															rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3],
															ex_tFileInputDelimited_3),
													ex_tFileInputDelimited_3));
										}
								...
								if (columnIndexWithD_tFileInputDelimited_3 < rowtFileInputDelimited_3.length) {
									...
									if (rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3].length() > 0) {
										try {
											...
											row6.CustomerID = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_3[columnIndexWithD_tFileInputDelimited_3]);
								...
								if (columnIndexWithD_tFileInputDelimited_4 < rowtFileInputDelimited_4.length) {
									...
									if (rowtFileInputDelimited_4[columnIndexWithD_tFileInputDelimited_4].length() > 0) {
										try {
											...
											row4.CustomerID = ParserUtils.parseTo_Integer(
								...
								if (columnIndexWithD_tFileInputDelimited_4 < rowtFileInputDelimited_4.length) {
									...
									if (rowtFileInputDelimited_4[columnIndexWithD_tFileInputDelimited_4].length() > 0) {
										try {
											...
											row4.AddressID = ParserUtils.parseTo_Integer(
													rowtFileInputDelimited_4[columnIndexWithD_tFileInputDelimited_4]);
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {
					...
					Object filename_tFileInputDelimited_5 = "C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/CURATED/DIM_Vendedor.csv";
							...
							if (temp.length() > 0) {
								...
								try {
									...
									rowstate_tFileInputDelimited_5.setException(new RuntimeException(String.format(
											...
											"SalesSK", "row5", temp, ex_tFileInputDelimited_5),
								...
								rowstate_tFileInputDelimited_5.setException(new RuntimeException(
										"Value is empty for column : 'SalesSK' in 'row5' connection, value is invalid or this column should be nullable or have a default value."));
								...
								if (columnIndexWithD_tFileInputDelimited_6 < rowtFileInputDelimited_6.length) {
									...
									if (rowtFileInputDelimited_6[columnIndexWithD_tFileInputDelimited_6].length() > 0) {
										try {
											...
											row3.ProductID = ParserUtils.parseTo_Integer(
...
// Start of branch "row3"
	...
	public static void main(String[] args) {
		final REL_Semanal_Vendas REL_Semanal_VendasClass = new REL_Semanal_Vendas();

		int exitCode = REL_Semanal_VendasClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = REL_Semanal_Vendas.class.getClassLoader().getResourceAsStream(
					"adventure_project/rel_semanal_vendas_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = REL_Semanal_Vendas.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : REL_Semanal_Vendas");
		}
...
/************************************************************************************************
 * 231978 characters generated by Talend Open Studio for Big Data on the 12 de
 * Julho de 2021 17h47min31s BRT
 ************************************************************************************************/