...
package adventure_project.dim_tempo_0_1;
...
/**
 * Job: Dim_Tempo Purpose: ETL entidade tempo<br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class Dim_Tempo implements TalendJob {
	...
	private final String jobName = "Dim_Tempo";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(Dim_Tempo.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
		final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_Dim_Tempo = new byte[0];
		static byte[] commonByteArray_ADVENTURE_PROJECT_Dim_Tempo = new byte[0];
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ADVENTURE_PROJECT_Dim_Tempo) {
	...
	public static class saida_dim_tempoStruct implements routines.system.IPersistableRow<saida_dim_tempoStruct> {
		final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_Dim_Tempo = new byte[0];
		static byte[] commonByteArray_ADVENTURE_PROJECT_Dim_Tempo = new byte[0];
		 ...
		 * Compare keys
		 */
		public int compareTo(saida_dim_tempoStruct other) {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ADVENTURE_PROJECT_Dim_Tempo.length) {
					if (length < 1024 && commonByteArray_ADVENTURE_PROJECT_Dim_Tempo.length == 0) {
						commonByteArray_ADVENTURE_PROJECT_Dim_Tempo = new byte[1024];
					} else {
						commonByteArray_ADVENTURE_PROJECT_Dim_Tempo = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ADVENTURE_PROJECT_Dim_Tempo, 0, length);
				strReturn = new String(commonByteArray_ADVENTURE_PROJECT_Dim_Tempo, 0, length, utf8Charset);
			}
			return strReturn;
		}
	...
	public void tFileInputDelimited_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				saida_dim_tempoStruct saida_dim_tempo = new saida_dim_tempoStruct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "saida_dim_tempo");
				}
				...
				class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
					...
					public int hashCode() {
						if (this.hashCodeDirty) {
							...
							result = prime * result + (int) this.Ano;

							result = prime * result + (int) this.Mes;

							result = prime * result + (int) this.SemanaAno;
					...
					public boolean equals(Object obj) {
						...
						if (this.SemanaAno != other.SemanaAno)
							return false;
...
// # Outputs initialization
				saida_dim_tempoStruct saida_dim_tempo_tmp = new saida_dim_tempoStruct();
// ###############################
...
// Start of branch "row1"
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								Var.SemanaAno = TalendDate.getPartOfDate("WEEK_OF_YEAR", row1.OrderDate);
								Var.Ano = TalendDate.getPartOfDate("YEAR", row1.OrderDate);
								Var.Mes = TalendDate.getPartOfDate("MONTH",
										TalendDate.addDate(row1.OrderDate, 1, "MM"));// ###############################
								// ###############################
								// # Output tables

								saida_dim_tempo = null;

// # Output table : 'saida_dim_tempo'
								saida_dim_tempo_tmp.OrderDate = row1.OrderDate;
								saida_dim_tempo_tmp.Ano = Var.Ano;
								saida_dim_tempo_tmp.Mes = Var.Mes;
								saida_dim_tempo_tmp.SemanaAno = Var.SemanaAno;
								saida_dim_tempo = saida_dim_tempo_tmp;
// ###############################
							...
							if (saida_dim_tempo != null) {
								...
								if (runTrace.isPause()) {
									...
									runTraceData.put("OrderDate", String.valueOf(saida_dim_tempo.OrderDate));

									runTraceData.put("Ano", String.valueOf(saida_dim_tempo.Ano));

									runTraceData.put("Mes", String.valueOf(saida_dim_tempo.Mes));

									runTraceData.put("SemanaAno", String.valueOf(saida_dim_tempo.SemanaAno));

									runTrace.sendTrace("saida_dim_tempo", "tFileInputDelimited_1", runTraceData);
								}
							 ...
							 */
// Start of branch "saida_dim_tempo"
							if (saida_dim_tempo != null) {
								...
								if (execStat) {
									runStat.updateStatOnConnection(iterateId, 1, 1, "saida_dim_tempo");
								}

								operation_finder_tAggregateRow_1.OrderDate = saida_dim_tempo.OrderDate;
								operation_finder_tAggregateRow_1.Ano = saida_dim_tempo.Ano;
								operation_finder_tAggregateRow_1.Mes = saida_dim_tempo.Mes;
								operation_finder_tAggregateRow_1.SemanaAno = saida_dim_tempo.SemanaAno;
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "saida_dim_tempo");
				}
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/CURATED/DIM_Tempo.csv"))
				...
				if (filetFileOutputDelimited_1.length() == 0) {
					...
					headColutFileOutputDelimited_1[1] = "Ano";
					headColutFileOutputDelimited_1[2] = "Mes";
					headColutFileOutputDelimited_1[3] = "SemanaAno";
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					row2.SemanaAno = aggregated_row_tAggregateRow_1.SemanaAno;
					...
					if (row2 != null) {
						...
						if (runTrace.isPause()) {
							...
							runTraceData.put("Ano", String.valueOf(row2.Ano));

							runTraceData.put("Mes", String.valueOf(row2.Mes));

							runTraceData.put("SemanaAno", String.valueOf(row2.SemanaAno));
					...
					rowtFileOutputDelimited_1[0] = row2.OrderDate == null ? null
							: FormatterUtils.format_Date(row2.OrderDate, "dd-MM-yyyy");
					rowtFileOutputDelimited_1[1] = String.valueOf(row2.Ano);
					rowtFileOutputDelimited_1[2] = String.valueOf(row2.Mes);
					rowtFileOutputDelimited_1[3] = String.valueOf(row2.SemanaAno);
	...
	public static void main(String[] args) {
		final Dim_Tempo Dim_TempoClass = new Dim_Tempo();

		int exitCode = Dim_TempoClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Tempo.class.getClassLoader()
					.getResourceAsStream("adventure_project/dim_tempo_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Dim_Tempo.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Tempo");
		}
...
/************************************************************************************************
 * 106390 characters generated by Talend Open Studio for Big Data on the 12 de
 * Julho de 2021 16h48min23s BRT
 ************************************************************************************************/