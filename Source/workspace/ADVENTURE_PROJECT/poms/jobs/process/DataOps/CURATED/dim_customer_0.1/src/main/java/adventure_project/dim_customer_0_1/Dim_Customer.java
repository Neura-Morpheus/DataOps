					...
					while (limittFileInputDelimited_1 != 0 && csvReadertFileInputDelimited_1 != null
						...
						if (row1 != null) {
							...
							if (runTrace.isPause()) {
								...
								runTraceData.put("NameStyle", String.valueOf(row1.NameStyle));

								runTraceData.put("Title", String.valueOf(row1.Title));

								runTraceData.put("FirstName", String.valueOf(row1.FirstName));

								runTraceData.put("MiddleName", String.valueOf(row1.MiddleName));

								runTraceData.put("LastName", String.valueOf(row1.LastName));

								runTraceData.put("Suffix", String.valueOf(row1.Suffix));

								runTraceData.put("CompanyName", String.valueOf(row1.CompanyName));

								runTraceData.put("SalesPerson", String.valueOf(row1.SalesPerson));

								runTraceData.put("EmailAddress", String.valueOf(row1.EmailAddress));

								runTraceData.put("Phone", String.valueOf(row1.Phone));
						...
						if (row1 != null) {
							...
							while ((tHash_Lookup_row4 != null && tHash_Lookup_row4.hasNext()) || forceLooprow4) { // G_TM_M_043
								...
								{ // start of Var scope
									...
									Var.FullName = StringHandling.TRIM(row1.FirstName) + " "
											+ StringHandling.TRIM(row1.MiddleName) + " "
											+ StringHandling.TRIM(row1.LastName) + "  "
											+ StringHandling.TRIM(row1.Suffix);// ###############################
									// ###############################
									// # Output tables
...
// # Output table : 'saida_Dim_Customer'
									...
									saida_Dim_Customer_tmp.AddressID = Relational.ISNULL(row4.AddressID) ? 0
											: row4.AddressID;
...
// ###############################
								...
								if (saida_Dim_Customer != null) {
									...
									if (runTrace.isPause()) {
										...
										runTraceData.put("CustomerID", String.valueOf(saida_Dim_Customer.CustomerID));

										runTraceData.put("AddressID", String.valueOf(saida_Dim_Customer.AddressID));

										runTraceData.put("NameStyle", String.valueOf(saida_Dim_Customer.NameStyle));

										runTraceData.put("Title", String.valueOf(saida_Dim_Customer.Title));

										runTraceData.put("FullName", String.valueOf(saida_Dim_Customer.FullName));

										runTraceData.put("CompanyName", String.valueOf(saida_Dim_Customer.CompanyName));

										runTraceData.put("SalesPerson", String.valueOf(saida_Dim_Customer.SalesPerson));

										runTraceData.put("EmailAddress",
												String.valueOf(saida_Dim_Customer.EmailAddress));

										runTraceData.put("Phone", String.valueOf(saida_Dim_Customer.Phone));

										runTraceData.put("AddressType", String.valueOf(saida_Dim_Customer.AddressType));

										runTraceData.put("AddressLine1",
												String.valueOf(saida_Dim_Customer.AddressLine1));

										runTraceData.put("AddressLine2",
												String.valueOf(saida_Dim_Customer.AddressLine2));

										runTraceData.put("City", String.valueOf(saida_Dim_Customer.City));

										runTraceData.put("StateProvince",
												String.valueOf(saida_Dim_Customer.StateProvince));

										runTraceData.put("CountryRegion",
												String.valueOf(saida_Dim_Customer.CountryRegion));

										runTraceData.put("PostalCode", String.valueOf(saida_Dim_Customer.PostalCode));

										runTrace.sendTrace("saida_Dim_Customer", "tFileInputDelimited_1", runTraceData);
									}
...
// ###############################      
				...
				fileName_tFileOutputDelimited_1 = (new java.io.File(
						"C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/CURATED/DIM_Cliente.csv"))
				...
				if (filetFileOutputDelimited_1.length() == 0) {
					...
					headColutFileOutputDelimited_1[16] = "var1";
				...
				for (AggOperationStruct_tAggregateRow_1 aggregated_row_tAggregateRow_1 : values_tAggregateRow_1) { // G_AggR_600
					...
					if (row3 != null) {
						...
						if (runTrace.isPause()) {
							...
							runTraceData.put("CustomerID", String.valueOf(row3.CustomerID));

							runTraceData.put("AddressID", String.valueOf(row3.AddressID));

							runTraceData.put("NameStyle", String.valueOf(row3.NameStyle));

							runTraceData.put("Title", String.valueOf(row3.Title));

							runTraceData.put("FullName", String.valueOf(row3.FullName));

							runTraceData.put("CompanyName", String.valueOf(row3.CompanyName));

							runTraceData.put("SalesPerson", String.valueOf(row3.SalesPerson));

							runTraceData.put("EmailAddress", String.valueOf(row3.EmailAddress));

							runTraceData.put("Phone", String.valueOf(row3.Phone));

							runTraceData.put("AddressType", String.valueOf(row3.AddressType));

							runTraceData.put("AddressLine1", String.valueOf(row3.AddressLine1));

							runTraceData.put("AddressLine2", String.valueOf(row3.AddressLine2));

							runTraceData.put("City", String.valueOf(row3.City));

							runTraceData.put("StateProvince", String.valueOf(row3.StateProvince));

							runTraceData.put("CountryRegion", String.valueOf(row3.CountryRegion));

							runTraceData.put("PostalCode", String.valueOf(row3.PostalCode));

							runTraceData.put("var1", String.valueOf(row3.var1));
					...
					rowtFileOutputDelimited_1[16] = String.valueOf(row3.var1);
	...
	public void tFileInputDelimited_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				// source node:tFilterRow_1 - inputs:(row2) outputs:(row4,row4) | target
				// node:tAdvancedHash_row4 - inputs:(row4) outputs:()
				// linked node: tMap_1 - inputs:(row1,row4) outputs:(saida_Dim_Customer)
					...
					while (limittFileInputDelimited_2 != 0 && csvReadertFileInputDelimited_2 != null
						...
						if (row2 != null) {
							...
							if (runTrace.isPause()) {
								...
								runTraceData.put("AddressID", String.valueOf(row2.AddressID));

								runTraceData.put("AddressType", String.valueOf(row2.AddressType));

								runTraceData.put("AddressLine1", String.valueOf(row2.AddressLine1));

								runTraceData.put("AddressLine2", String.valueOf(row2.AddressLine2));

								runTraceData.put("City", String.valueOf(row2.City));

								runTraceData.put("StateProvince", String.valueOf(row2.StateProvince));

								runTraceData.put("CountryRegion", String.valueOf(row2.CountryRegion));

								runTraceData.put("PostalCode", String.valueOf(row2.PostalCode));
...
// Start of branch "row2"
						if (row2 != null) {
							...
							ope_tFilterRow_1.matches(
									(row2.AddressType == null ? false
											: row2.AddressType.matches("Main Office") == true),
...
// Start of branch "row4"
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Dim_Customer.class.getClassLoader()
					.getResourceAsStream("adventure_project/dim_customer_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = Dim_Customer.class.getClassLoader()
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_Customer");
		}
...
/************************************************************************************************
 * 176811 characters generated by Talend Open Studio for Big Data on the 10 de
 * Julho de 2021 0h44min40s BRT
 ************************************************************************************************/