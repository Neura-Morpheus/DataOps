...
package adventure_project.productdescription_harm_0_1;
...
/**
 * Job: ProductDescription_HARM Purpose: ETL area HARMONIZED<br>
 * Description: Carga de dados ProductDescription area HARMONIZED <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class ProductDescription_HARM implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "ProductDescription_HARM";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProductDescription_HARM.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProductDescription_HARM.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_ProductDescription_HARM = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_ProductDescription_HARM = new byte[0];

	
			    public Integer ProductDescriptionID;
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADVENTURE_PROJECT_ProductDescription_HARM.length) {
				if(length < 1024 && commonByteArray_ADVENTURE_PROJECT_ProductDescription_HARM.length == 0) {
   					commonByteArray_ADVENTURE_PROJECT_ProductDescription_HARM = new byte[1024];
				} else {
   					commonByteArray_ADVENTURE_PROJECT_ProductDescription_HARM = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADVENTURE_PROJECT_ProductDescription_HARM, 0, length);
			strReturn = new String(commonByteArray_ADVENTURE_PROJECT_ProductDescription_HARM, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADVENTURE_PROJECT_ProductDescription_HARM) {

        	try {

        		int length = 0;
		
						this.ProductDescriptionID = readInteger(dis);
    ...
    public void writeData(ObjectOutputStream dos) {
        try {
					...
					// Integer
						...
						writeInteger(this.ProductDescriptionID,dos);
...
public static class saida_ProductDescrStruct implements routines.system.IPersistableRow<saida_ProductDescrStruct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_ProductDescription_HARM = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_ProductDescription_HARM = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final saida_ProductDescrStruct other = (saida_ProductDescrStruct) obj;
	...
	public void copyDataTo(saida_ProductDescrStruct other) {
	...
	public void copyKeysDataTo(saida_ProductDescrStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(saida_ProductDescrStruct other) {
...
saida_ProductDescrStruct saida_ProductDescr = new saida_ProductDescrStruct();
row3Struct row3 = new row3Struct();
	...
	currentComponent="tAggregateRow_1_AGGOUT";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"saida_ProductDescr");
					}
...
saida_ProductDescrStruct saida_ProductDescr_tmp = new saida_ProductDescrStruct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */"C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/RAW/ProductDescription.csv"/** End field tFileInputDelimited_1:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.ProductDescriptionID = ParserUtils.parseTo_int(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
									
									
										} catch(java.lang.Exception ex_tFileInputDelimited_1) {
											rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"ProductDescriptionID", "row1", rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
										}
    								}else{
    									
    										rowstate_tFileInputDelimited_1.setException(new RuntimeException("Value is empty for column : 'ProductDescriptionID' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.ProductDescriptionID = row1.ProductDescriptionID ;
...
saida_ProductDescr = null;

if(!rejectedInnerJoin_tMap_1 ) {

// # Output table : 'saida_ProductDescr'
saida_ProductDescr_tmp.ProductModelID = row2.ProductModelID ;
saida_ProductDescr_tmp.Culture = row2.Culture ;
saida_ProductDescr_tmp.Description = row1.Description ;
saida_ProductDescr = saida_ProductDescr_tmp;
 ...
 */
// Start of branch "saida_ProductDescr"
if(saida_ProductDescr != null) { 
	...
	currentComponent="tAggregateRow_1_AGGOUT";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"saida_ProductDescr");
					}
					
	
operation_finder_tAggregateRow_1.ProductModelID = saida_ProductDescr.ProductModelID;
			operation_finder_tAggregateRow_1.Culture = saida_ProductDescr.Culture;
			operation_finder_tAggregateRow_1.Description = saida_ProductDescr.Description;
	...
	if(operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
		...
		operation_result_tAggregateRow_1.ProductModelID = operation_finder_tAggregateRow_1.ProductModelID;
				operation_result_tAggregateRow_1.Culture = operation_finder_tAggregateRow_1.Culture;
				operation_result_tAggregateRow_1.Description = operation_finder_tAggregateRow_1.Description;
...
} // End of branch "saida_ProductDescr"
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGOUT";
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"saida_ProductDescr");
			  	}
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/HARMONIZED/ProductionDescription_HARM.csv")).getAbsolutePath().replace("\\","/");
            ...
            csvSettings_tFileOutputDelimited_1.setEscapeAndTextEnclosure("\"","\"");
                    ...
                    if(!csvSettings_tFileOutputDelimited_1.isUseCRLFRecordDelimiter() && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\r' && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\n') {
                        ...
                        if(filetFileOutputDelimited_1.length()==0){
                                    headColutFileOutputDelimited_1[0]="ProductDescriptionID";
                                    headColutFileOutputDelimited_1[1]="Culture";
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
            				    ...
            				    row3.ProductDescriptionID = aggregated_row_tAggregateRow_1.ProductModelID;
            				    
            				    row3.Culture = aggregated_row_tAggregateRow_1.Culture;
            				    
            				    row3.Description = aggregated_row_tAggregateRow_1.Description;
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_1=new String[3];
                            rowtFileOutputDelimited_1[0]=row3.ProductDescriptionID == null ? null : String.valueOf(row3.ProductDescriptionID);
                            rowtFileOutputDelimited_1[1]=row3.Culture == null ? null : row3.Culture;
                            rowtFileOutputDelimited_1[2]=row3.Description == null ? null : row3.Description;
...
public static class row2Struct implements routines.system.IPersistableComparableLookupRow<row2Struct> {
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.ProductDescriptionID == null) ? 0 : this.ProductDescriptionID.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row2Struct other = (row2Struct) obj;
						...
						} else if (!this.ProductDescriptionID.equals(other.ProductDescriptionID))
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2) outputs:(saida_ProductDescr)
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_2 = /** Start field tFileInputDelimited_2:FILENAME */"C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/RAW/ProductModelProductDescription.csv"/** End field tFileInputDelimited_2:FILENAME */;		
			...
			if(footer_value_tFileInputDelimited_2 > 0){
				...
				if(rowtFileInputDelimited_2.length == 1 && ("\015").equals(rowtFileInputDelimited_2[0])){//empty line when row separator is '\n'
							...
							row2.ProductDescriptionID = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row2.ProductModelID = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
											...
											rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"ProductModelID", "row2", rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row2.ProductDescriptionID = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
									
									
										} catch(java.lang.Exception ex_tFileInputDelimited_2) {
											rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"ProductDescriptionID", "row2", rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row2.Culture = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
if(row2 != null) { 
	...
	currentComponent="tAdvancedHash_row2";
				...
				row2_HashRow.ProductModelID = row2.ProductModelID;
				
				row2_HashRow.ProductDescriptionID = row2.ProductDescriptionID;
				
				row2_HashRow.Culture = row2.Culture;
 ...
 */
    ...
    public static void main(String[] args){
        final ProductDescription_HARM ProductDescription_HARMClass = new ProductDescription_HARM();

        int exitCode = ProductDescription_HARMClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProductDescription_HARM.class.getClassLoader().getResourceAsStream("adventure_project/productdescription_harm_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ProductDescription_HARM.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProductDescription_HARM");
        }
...
/************************************************************************************************
 *     119261 characters generated by Talend Open Studio for Big Data 
 *     on the 8 de Julho de 2021 1h12min10s BRT
 ************************************************************************************************/