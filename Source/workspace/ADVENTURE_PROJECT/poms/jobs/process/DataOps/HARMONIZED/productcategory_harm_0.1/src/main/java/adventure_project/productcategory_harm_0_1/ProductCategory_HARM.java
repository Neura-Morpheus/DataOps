...
package adventure_project.productcategory_harm_0_1;
...
/**
 * Job: ProductCategory_HARM Purpose: ETL area HARMONIZED<br>
 * Description: Carga de dados tabela ProductCategory area HARMONIZED <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class ProductCategory_HARM implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "ProductCategory_HARM";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProductCategory_HARM.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProductCategory_HARM.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_ProductCategory_HARM = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_ProductCategory_HARM = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADVENTURE_PROJECT_ProductCategory_HARM.length) {
				if(length < 1024 && commonByteArray_ADVENTURE_PROJECT_ProductCategory_HARM.length == 0) {
   					commonByteArray_ADVENTURE_PROJECT_ProductCategory_HARM = new byte[1024];
				} else {
   					commonByteArray_ADVENTURE_PROJECT_ProductCategory_HARM = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADVENTURE_PROJECT_ProductCategory_HARM, 0, length);
			strReturn = new String(commonByteArray_ADVENTURE_PROJECT_ProductCategory_HARM, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADVENTURE_PROJECT_ProductCategory_HARM) {
...
public static class saida_ProductCategoryStruct implements routines.system.IPersistableRow<saida_ProductCategoryStruct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_ProductCategory_HARM = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_ProductCategory_HARM = new byte[0];
     ...
     * Compare keys
     */
    public int compareTo(saida_ProductCategoryStruct other) {
...
saida_ProductCategoryStruct saida_ProductCategory = new saida_ProductCategoryStruct();
row3Struct row3 = new row3Struct();
	...
	currentComponent="tAggregateRow_1_AGGOUT";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"saida_ProductCategory");
					}
...
saida_ProductCategoryStruct saida_ProductCategory_tmp = new saida_ProductCategoryStruct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */"C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/RAW/ProductCategory.csv"/** End field tFileInputDelimited_1:FILENAME */;		
			...
			if(footer_value_tFileInputDelimited_1 > 0){
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
							...
							row1.ParentProductCategoryID = null;
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.ParentProductCategoryID = ParserUtils.parseTo_Integer(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
									
									
										} catch(java.lang.Exception ex_tFileInputDelimited_1) {
											rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"ParentProductCategoryID", "row1", rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
										}
    								}else{
 					    ...
 					    boolean forceLooprow2 = false;
 							...
 							row2Struct row2ObjectFromLookup = null;
								...
								hasCasePrimitiveKeyWithNull_tMap_1 = false;
                        		    		    ...
                        		    		    row2HashKey.ProductCategoryID = row1.ParentProductCategoryID ;
...
saida_ProductCategory = null;

if(!rejectedInnerJoin_tMap_1 ) {

// # Output table : 'saida_ProductCategory'
saida_ProductCategory_tmp.ProductCategoryID = row1.ProductCategoryID ;
saida_ProductCategory_tmp.Categoria = row2.Name ;
saida_ProductCategory_tmp.Subcategoria = row1.Name ;
saida_ProductCategory = saida_ProductCategory_tmp;
 ...
 */
// Start of branch "saida_ProductCategory"
if(saida_ProductCategory != null) { 
	...
	currentComponent="tAggregateRow_1_AGGOUT";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"saida_ProductCategory");
					}
					
	
operation_finder_tAggregateRow_1.ProductCategoryID = saida_ProductCategory.ProductCategoryID;
			operation_finder_tAggregateRow_1.Categoria = saida_ProductCategory.Categoria;
			operation_finder_tAggregateRow_1.Subcategoria = saida_ProductCategory.Subcategoria;
	...
	if(operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
		...
		operation_result_tAggregateRow_1.ProductCategoryID = operation_finder_tAggregateRow_1.ProductCategoryID;
...
} // End of branch "saida_ProductCategory"
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGOUT";
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"saida_ProductCategory");
			  	}
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/HARMONIZED/ProductCategory_HARM.csv")).getAbsolutePath().replace("\\","/");
            ...
            csvSettings_tFileOutputDelimited_1.setEscapeAndTextEnclosure("\"","\"");
                    ...
                    if(!csvSettings_tFileOutputDelimited_1.isUseCRLFRecordDelimiter() && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\r' && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\n') {
                        ...
                        if(filetFileOutputDelimited_1.length()==0){
                                    headColutFileOutputDelimited_1[0]="ProductCategoryID";
                                    headColutFileOutputDelimited_1[1]="Categoria";
                                    headColutFileOutputDelimited_1[2]="Subcategoria";
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
            				    ...
            				    row3.ProductCategoryID = aggregated_row_tAggregateRow_1.ProductCategoryID;
            				    
            				    row3.Categoria = aggregated_row_tAggregateRow_1.Categoria;
            				    
            				    row3.Subcategoria = aggregated_row_tAggregateRow_1.Subcategoria;
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_1=new String[3];
                            rowtFileOutputDelimited_1[0]=row3.ProductCategoryID == null ? null : String.valueOf(row3.ProductCategoryID);
                            rowtFileOutputDelimited_1[1]=row3.Categoria == null ? null : row3.Categoria;
                            rowtFileOutputDelimited_1[2]=row3.Subcategoria == null ? null : row3.Subcategoria;
 ...
 final boolean execStat = this.execStat;
	...
	currentComponent="tAdvancedHash_row2";
		...
		int tos_count_tAdvancedHash_row2 = 0;
			   		...
			   		// linked node: tMap_1 - inputs:(row1,row2) outputs:(saida_ProductCategory)
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_2 = /** Start field tFileInputDelimited_2:FILENAME */"C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/RAW/ProductCategory.csv"/** End field tFileInputDelimited_2:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row2.ParentProductCategoryID = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
									
									
										} catch(java.lang.Exception ex_tFileInputDelimited_2) {
											rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"ParentProductCategoryID", "row2", rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
										}
    								}else{
 ...
 */
    ...
    public static void main(String[] args){
        final ProductCategory_HARM ProductCategory_HARMClass = new ProductCategory_HARM();

        int exitCode = ProductCategory_HARMClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProductCategory_HARM.class.getClassLoader().getResourceAsStream("adventure_project/productcategory_harm_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ProductCategory_HARM.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProductCategory_HARM");
        }
...
/************************************************************************************************
 *     119035 characters generated by Talend Open Studio for Big Data 
