...
package adventure_project.productmodel_harm_0_1;
...
/**
 * Job: ProductModel_HARM Purpose: ETL area HARMONIZED<br>
 * Description: Carga de dados tabela ProductModel area HARMONIZED <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class ProductModel_HARM implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "ProductModel_HARM";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				ProductModel_HARM.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(ProductModel_HARM.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class saida_ProductModelStruct implements routines.system.IPersistableRow<saida_ProductModelStruct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_ProductModel_HARM = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_ProductModel_HARM = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final saida_ProductModelStruct other = (saida_ProductModelStruct) obj;
	...
	public void copyDataTo(saida_ProductModelStruct other) {
	...
	public void copyKeysDataTo(saida_ProductModelStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADVENTURE_PROJECT_ProductModel_HARM.length) {
				if(length < 1024 && commonByteArray_ADVENTURE_PROJECT_ProductModel_HARM.length == 0) {
   					commonByteArray_ADVENTURE_PROJECT_ProductModel_HARM = new byte[1024];
				} else {
   					commonByteArray_ADVENTURE_PROJECT_ProductModel_HARM = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADVENTURE_PROJECT_ProductModel_HARM, 0, length);
			strReturn = new String(commonByteArray_ADVENTURE_PROJECT_ProductModel_HARM, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADVENTURE_PROJECT_ProductModel_HARM) {
     ...
     * Compare keys
     */
    public int compareTo(saida_ProductModelStruct other) {
...
saida_ProductModelStruct saida_ProductModel = new saida_ProductModelStruct();
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"saida_ProductModel");
					}
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/HARMONIZED/ProductModel_HARM.csv")).getAbsolutePath().replace("\\","/");
            ...
            csvSettings_tFileOutputDelimited_1.setEscapeAndTextEnclosure("\"","\"");
                    ...
                    if(!csvSettings_tFileOutputDelimited_1.isUseCRLFRecordDelimiter() && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\r' && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\n') {
                        ...
                        if(filetFileOutputDelimited_1.length()==0){
                                    ...
                                    headColutFileOutputDelimited_1[2]="CatalogDescription";
...
saida_ProductModelStruct saida_ProductModel_tmp = new saida_ProductModelStruct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_2 = /** Start field tFileInputDelimited_2:FILENAME */"C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/RAW/ProductModel.csv"/** End field tFileInputDelimited_2:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row1.ProductModelID = ParserUtils.parseTo_int(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
											...
											rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"ProductModelID", "row1", rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
										}
    								}else{
    									
    										rowstate_tFileInputDelimited_2.setException(new RuntimeException("Value is empty for column : 'ProductModelID' in 'row1' connection, value is invalid or this column should be nullable or have a default value."));
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row1.CatalogDescription = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										try {
											...
											row1.ModifiedDate = ParserUtils.parseTo_Date(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], "dd-MM-yyyy");
										
									
										} catch(java.lang.Exception ex_tFileInputDelimited_2) {
											rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"ModifiedDate", "row1", rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
										}
    								}else{
...
saida_ProductModel = null;


// # Output table : 'saida_ProductModel'
saida_ProductModel_tmp.ProductModelID = row1.ProductModelID;
saida_ProductModel_tmp.Name = row1.Name;
saida_ProductModel_tmp.CatalogDescription = null;
saida_ProductModel = saida_ProductModel_tmp;
// ###############################
 ...
 */
// Start of branch "saida_ProductModel"
if(saida_ProductModel != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"saida_ProductModel");
					}
					


                        String[] rowtFileOutputDelimited_1=new String[3];
                            rowtFileOutputDelimited_1[0]=saida_ProductModel.ProductModelID == null ? null : String.valueOf(saida_ProductModel.ProductModelID);
                            rowtFileOutputDelimited_1[1]=saida_ProductModel.Name == null ? null : saida_ProductModel.Name;
                            rowtFileOutputDelimited_1[2]=saida_ProductModel.CatalogDescription == null ? null : saida_ProductModel.CatalogDescription;
...
} // End of branch "saida_ProductModel"
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
		...
		resourceMap.put("finish_tFileOutputDelimited_1", true);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"saida_ProductModel");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final ProductModel_HARM ProductModel_HARMClass = new ProductModel_HARM();

        int exitCode = ProductModel_HARMClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = ProductModel_HARM.class.getClassLoader().getResourceAsStream("adventure_project/productmodel_harm_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = ProductModel_HARM.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : ProductModel_HARM");
        }
...
/************************************************************************************************
 *     65057 characters generated by Talend Open Studio for Big Data 
