...
package adventure_project.salesorderdetail_harm_0_1;
...
/**
 * Job: SalesOrderDetail_HARM Purpose: ETL area HARMONIZED<br>
 * Description: Carga de dados tabela SalesOrderDetail area HARMONIZED <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class SalesOrderDetail_HARM implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SalesOrderDetail_HARM";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SalesOrderDetail_HARM.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SalesOrderDetail_HARM.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class saida_SalesOrderDetailStruct implements routines.system.IPersistableRow<saida_SalesOrderDetailStruct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_SalesOrderDetail_HARM = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_SalesOrderDetail_HARM = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final saida_SalesOrderDetailStruct other = (saida_SalesOrderDetailStruct) obj;
	...
	public void copyDataTo(saida_SalesOrderDetailStruct other) {
	...
	public void copyKeysDataTo(saida_SalesOrderDetailStruct other) {
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADVENTURE_PROJECT_SalesOrderDetail_HARM) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/HARMONIZED/SalesOrderDetail_HARM.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */"C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/RAW/SalesOrderDetail.csv"/** End field tFileInputDelimited_1:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.SalesOrderDetailID = ParserUtils.parseTo_int(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.UnitPrice = ParserUtils.parseTo_Float(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
									
									
										} catch(java.lang.Exception ex_tFileInputDelimited_1) {
											rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"UnitPrice", "row1", rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.UnitPriceDiscount = ParserUtils.parseTo_Float(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
									
									
										} catch(java.lang.Exception ex_tFileInputDelimited_1) {
											rowstate_tFileInputDelimited_1.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"UnitPriceDiscount", "row1", rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1], ex_tFileInputDelimited_1), ex_tFileInputDelimited_1));
										}
    								}else{
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_1=new String[7];
                            rowtFileOutputDelimited_1[0]=String.valueOf(saida_SalesOrderDetail.SalesOrderID);
                            rowtFileOutputDelimited_1[1]=String.valueOf(saida_SalesOrderDetail.SalesOrderDetailID);
 ...
 */
    ...
    public static void main(String[] args){
        final SalesOrderDetail_HARM SalesOrderDetail_HARMClass = new SalesOrderDetail_HARM();

        int exitCode = SalesOrderDetail_HARMClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SalesOrderDetail_HARM.class.getClassLoader().getResourceAsStream("adventure_project/salesorderdetail_harm_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SalesOrderDetail_HARM.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SalesOrderDetail_HARM");
        }
...
/************************************************************************************************
 *     76283 characters generated by Talend Open Studio for Big Data 
