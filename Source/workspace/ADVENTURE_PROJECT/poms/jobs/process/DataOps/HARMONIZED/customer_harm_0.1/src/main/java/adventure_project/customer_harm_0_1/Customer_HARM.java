...
package adventure_project.customer_harm_0_1;
...
/**
 * Job: Customer_HARM Purpose: ETL area HARMONIZED<br>
 * Description: Carga de dados Customer area HARMONIZED <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Customer_HARM implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Customer_HARM";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Customer_HARM.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Customer_HARM.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class saida_CustomerStruct implements routines.system.IPersistableRow<saida_CustomerStruct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_Customer_HARM = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_Customer_HARM = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final saida_CustomerStruct other = (saida_CustomerStruct) obj;
	...
	public void copyDataTo(saida_CustomerStruct other) {
	...
	public void copyKeysDataTo(saida_CustomerStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADVENTURE_PROJECT_Customer_HARM.length) {
				if(length < 1024 && commonByteArray_ADVENTURE_PROJECT_Customer_HARM.length == 0) {
   					commonByteArray_ADVENTURE_PROJECT_Customer_HARM = new byte[1024];
				} else {
   					commonByteArray_ADVENTURE_PROJECT_Customer_HARM = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADVENTURE_PROJECT_Customer_HARM, 0, length);
			strReturn = new String(commonByteArray_ADVENTURE_PROJECT_Customer_HARM, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADVENTURE_PROJECT_Customer_HARM) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/HARMONIZED/Customer_HARM.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */"C:/Users/USER/OneDrive/FIAP/12ABD/repos/DataOps/Dados/RAW/Customer.csv"/** End field tFileInputDelimited_1:FILENAME */;		
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_1=new String[11];
                            rowtFileOutputDelimited_1[0]=String.valueOf(saida_Customer.CustomerID);
 ...
 */
    ...
    public static void main(String[] args){
        final Customer_HARM Customer_HARMClass = new Customer_HARM();

        int exitCode = Customer_HARMClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Customer_HARM.class.getClassLoader().getResourceAsStream("adventure_project/customer_harm_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Customer_HARM.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Customer_HARM");
        }
...
/************************************************************************************************
 *     76102 characters generated by Talend Open Studio for Big Data 
