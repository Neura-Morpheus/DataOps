...
public class TMSSqlRowBeginJava
{
  ...
  protected final String TEXT_120 = " = null;" + NL + "\t\t        if(dbschema_";
  ...
  protected final String TEXT_127 = " + \"]\";" + NL + "\t\t        }" + NL + "\t\t        stmt_";
  protected final String TEXT_128 = ".execute(\"SET IDENTITY_INSERT \"+ tableName_";
  protected final String TEXT_129 = " +\" ON\");" + NL + "\t\t\t";
