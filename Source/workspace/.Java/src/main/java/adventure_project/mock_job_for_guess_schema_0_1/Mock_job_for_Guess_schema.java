...
package adventure_project.mock_job_for_guess_schema_0_1;
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Mock_job_for_Guess_schema.class.getClassLoader().getResourceAsStream(
					"adventure_project/mock_job_for_guess_schema_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 45607 characters generated by Talend Open Studio for Big Data on the 11 de
 * Maio de 2021 21h39min58s BRT
 ************************************************************************************************/