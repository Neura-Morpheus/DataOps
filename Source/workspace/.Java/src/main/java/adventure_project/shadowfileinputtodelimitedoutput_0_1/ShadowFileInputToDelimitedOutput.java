...
package adventure_project.shadowfileinputtodelimitedoutput_0_1;
...
public class ShadowFileInputToDelimitedOutput implements TalendJob {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_ShadowFileInputToDelimitedOutput = new byte[0];
		static byte[] commonByteArray_ADVENTURE_PROJECT_ShadowFileInputToDelimitedOutput = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ADVENTURE_PROJECT_ShadowFileInputToDelimitedOutput.length) {
					if (length < 1024
							&& commonByteArray_ADVENTURE_PROJECT_ShadowFileInputToDelimitedOutput.length == 0) {
						commonByteArray_ADVENTURE_PROJECT_ShadowFileInputToDelimitedOutput = new byte[1024];
					} else {
						commonByteArray_ADVENTURE_PROJECT_ShadowFileInputToDelimitedOutput = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ADVENTURE_PROJECT_ShadowFileInputToDelimitedOutput, 0, length);
				strReturn = new String(commonByteArray_ADVENTURE_PROJECT_ShadowFileInputToDelimitedOutput, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ADVENTURE_PROJECT_ShadowFileInputToDelimitedOutput) {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited = (new java.io.File(
						"C:/Repos/DataOps/Source/workspace/ADVENTURE_PROJECT/temp/preview/SalesOrderHeader.csv"))
				...
				String[] headColutFileOutputDelimited = new String[22];
				...
				Object filename_tFileInputDelimited = /** Start field tFileInputDelimited:FILENAME */
						"C:/Repos/DataOps/Dados/RAW/SalesOrderHeader.csv"/** End field tFileInputDelimited:FILENAME */
				;
...
// Start of branch "Row"
						if (Row != null) {
							...
							String[] rowtFileOutputDelimited = new String[22];
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = ShadowFileInputToDelimitedOutput.class.getClassLoader().getResourceAsStream(
					"adventure_project/shadowfileinputtodelimitedoutput_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 63334 characters generated by Talend Open Studio for Big Data on the 13 de
 * Julho de 2021 13h37min2s BRT
 ************************************************************************************************/