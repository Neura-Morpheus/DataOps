...
package adventure_project.expression_builder_rowgenerator2;
...
public class Expression_builder_RowGenerator2 implements TalendJob {
	...
	public static class RowStruct implements routines.system.IPersistableRow<RowStruct> {
		final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_Expression_builder_RowGenerator2 = new byte[0];
		static byte[] commonByteArray_ADVENTURE_PROJECT_Expression_builder_RowGenerator2 = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_ADVENTURE_PROJECT_Expression_builder_RowGenerator2.length) {
					if (length < 1024
							&& commonByteArray_ADVENTURE_PROJECT_Expression_builder_RowGenerator2.length == 0) {
						commonByteArray_ADVENTURE_PROJECT_Expression_builder_RowGenerator2 = new byte[1024];
					} else {
						commonByteArray_ADVENTURE_PROJECT_Expression_builder_RowGenerator2 = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_ADVENTURE_PROJECT_Expression_builder_RowGenerator2, 0, length);
				strReturn = new String(commonByteArray_ADVENTURE_PROJECT_Expression_builder_RowGenerator2, 0, length,
						utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_ADVENTURE_PROJECT_Expression_builder_RowGenerator2) {
...
///////////////////////    			
				...
				class tRowGenerator_1Randomizer {
					public String getRandomnewColumn() {
						...
						return "" + (TalendDate.getPartOfDate("MONTH", TalendDate.addDate(null, 1, "MM"))) + "";
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = Expression_builder_RowGenerator2.class.getClassLoader().getResourceAsStream(
					"adventure_project/expression_builder_rowgenerator2/contexts/" + contextStr + ".properties");
			if (inContext == null) {
...
/************************************************************************************************
 * 30653 characters generated by Talend Open Studio for Big Data on the 12 de
 * Julho de 2021 16h2min7s BRT
 ************************************************************************************************/