...
public static class saida_dim_tempoStruct implements routines.system.IPersistableRow<saida_dim_tempoStruct> {
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final saida_dim_tempoStruct other = (saida_dim_tempoStruct) obj;
	...
	public void copyDataTo(saida_dim_tempoStruct other) {
	...
	public void copyKeysDataTo(saida_dim_tempoStruct other) {
...
Var.Mes = TalendDate.getPartOfDate("MONTH",TalendDate.addDate(row1.OrderDate,1,"MM")) ;// ###############################
        // ###############################
        // # Output tables
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Repos/DataOps/Dados/CURATED/DIM_Tempo.csv")).getAbsolutePath().replace("\\","/");
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_1=new String[4];
                            rowtFileOutputDelimited_1[0]=row2.OrderDate == null ? null : FormatterUtils.format_Date(row2.OrderDate, "dd-MM-yyyy");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Tempo.class.getClassLoader().getResourceAsStream("adventure_project/dim_tempo_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_Tempo.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
/************************************************************************************************
 *     105589 characters generated by Talend Open Studio for Big Data 
 *     on the 13 de Julho de 2021 14h30min26s BRT
 ************************************************************************************************/