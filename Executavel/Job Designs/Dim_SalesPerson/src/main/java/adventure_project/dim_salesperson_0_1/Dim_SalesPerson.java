...
package adventure_project.dim_salesperson_0_1;
...
/**
 * Job: Dim_SalesPerson Purpose: Entidade Vendedor<br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class Dim_SalesPerson implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "Dim_SalesPerson";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				Dim_SalesPerson.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(Dim_SalesPerson.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row3Struct implements routines.system.IPersistableRow<row3Struct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_Dim_SalesPerson = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_Dim_SalesPerson = new byte[0];
	...
	public int hashCode() {
		if (this.hashCodeDirty) {
			...
			int result = DEFAULT_HASHCODE;
						...
						result = prime * result + ((this.SalesSK == null) ? 0 : this.SalesSK.hashCode());
	...
	public boolean equals(Object obj) {
		...
		final row3Struct other = (row3Struct) obj;
						...
						if (this.SalesSK == null) {
							if (other.SalesSK != null)
								return false;
						
						} else if (!this.SalesSK.equals(other.SalesSK))
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADVENTURE_PROJECT_Dim_SalesPerson.length) {
				if(length < 1024 && commonByteArray_ADVENTURE_PROJECT_Dim_SalesPerson.length == 0) {
   					commonByteArray_ADVENTURE_PROJECT_Dim_SalesPerson = new byte[1024];
				} else {
   					commonByteArray_ADVENTURE_PROJECT_Dim_SalesPerson = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADVENTURE_PROJECT_Dim_SalesPerson, 0, length);
			strReturn = new String(commonByteArray_ADVENTURE_PROJECT_Dim_SalesPerson, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADVENTURE_PROJECT_Dim_SalesPerson) {
...
public static class saida_Dim_VendedorStruct implements routines.system.IPersistableRow<saida_Dim_VendedorStruct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_Dim_SalesPerson = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_Dim_SalesPerson = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final saida_Dim_VendedorStruct other = (saida_Dim_VendedorStruct) obj;
	...
	public void copyDataTo(saida_Dim_VendedorStruct other) {
	...
	public void copyKeysDataTo(saida_Dim_VendedorStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(saida_Dim_VendedorStruct other) {
...
public static class saida_Sample_vendedorStruct implements routines.system.IPersistableRow<saida_Sample_vendedorStruct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_Dim_SalesPerson = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_Dim_SalesPerson = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final saida_Sample_vendedorStruct other = (saida_Sample_vendedorStruct) obj;
	...
	public void copyDataTo(saida_Sample_vendedorStruct other) {
	...
	public void copyKeysDataTo(saida_Sample_vendedorStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(saida_Sample_vendedorStruct other) {
...
saida_Dim_VendedorStruct saida_Dim_Vendedor = new saida_Dim_VendedorStruct();
saida_Sample_vendedorStruct saida_Sample_vendedor = new saida_Sample_vendedorStruct();
...
operation_finder_tAggregateRow_1.SalesPerson = row1.SalesPerson;
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"saida_Dim_Vendedor");
					}
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Repos/DataOps/Dados/CURATED/DIM_Vendedor.csv")).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_1 != null && directory_tFileOutputDelimited_1.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_1, false),"UTF-8"));
                                    if(filetFileOutputDelimited_1.length()==0){
                                        outtFileOutputDelimited_1.write("SalesSK");
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File("C:/Repos/DataOps/Dados/CURATED/SAMPLE_Vendedor.csv")).getAbsolutePath().replace("\\","/");
                    ...
                    if(directory_tFileOutputDelimited_2 != null && directory_tFileOutputDelimited_2.trim().length() != 0) {
                        ...
                        new java.io.FileOutputStream(fileName_tFileOutputDelimited_2, false),"UTF-8"));
                                    if(filetFileOutputDelimited_2.length()==0){
                                        outtFileOutputDelimited_2.write("SalesSK");
 ...
 */
	...
	currentComponent="tSampleRow_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"saida_Sample_vendedor");
					}
...
saida_Dim_VendedorStruct saida_Dim_Vendedor_tmp = new saida_Dim_VendedorStruct();
saida_Sample_vendedorStruct saida_Sample_vendedor_tmp = new saida_Sample_vendedorStruct();
// ###############################
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
            				    ...
            				    row2.SalesPerson = aggregated_row_tAggregateRow_1.SalesPerson;
...
Var.SalesSK = Numeric.sequence("s1",1,1) ;// ###############################
        // ###############################
        // # Output tables

saida_Dim_Vendedor = null;
saida_Sample_vendedor = null;


// # Output table : 'saida_Dim_Vendedor'
saida_Dim_Vendedor_tmp.SalesSK = Var.SalesSK ;
saida_Dim_Vendedor_tmp.SalesPerson = row2.SalesPerson ;
saida_Dim_Vendedor = saida_Dim_Vendedor_tmp;

// # Output table : 'saida_Sample_vendedor'
saida_Sample_vendedor_tmp.SalesSK = Var.SalesSK ;
saida_Sample_vendedor_tmp.SalesPerson = row2.SalesPerson ;
saida_Sample_vendedor = saida_Sample_vendedor_tmp;
// ###############################
 ...
 */
// Start of branch "saida_Dim_Vendedor"
if(saida_Dim_Vendedor != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"saida_Dim_Vendedor");
					}
					


                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                            if(saida_Dim_Vendedor.SalesSK != null) {
                        sb_tFileOutputDelimited_1.append(
                            saida_Dim_Vendedor.SalesSK
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(saida_Dim_Vendedor.SalesPerson != null) {
                        sb_tFileOutputDelimited_1.append(
                            saida_Dim_Vendedor.SalesPerson
                        );
                            }
...
} // End of branch "saida_Dim_Vendedor"




// Start of branch "saida_Sample_vendedor"
if(saida_Sample_vendedor != null) { 
	...
	currentComponent="tSampleRow_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"saida_Sample_vendedor");
					}
	...
	nb_line_tSampleRow_1++;
 	...
 	if(!rangeSettSampleRow_1.contains(nb_line_tSampleRow_1)){        
       ...
       row3.SalesSK = saida_Sample_vendedor.SalesSK;
       

       row3.SalesPerson = saida_Sample_vendedor.SalesPerson;
...
if(row3 != null) { 
	...
	currentComponent="tFileOutputDelimited_2";
                    ...
                    StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
                            if(row3.SalesSK != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.SalesSK
                        );
                            }
                            sb_tFileOutputDelimited_2.append(OUT_DELIM_tFileOutputDelimited_2);
                            if(row3.SalesPerson != null) {
                        sb_tFileOutputDelimited_2.append(
                            row3.SalesPerson
                        );
                            }
...
} // End of branch "saida_Sample_vendedor"
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
		...
		resourceMap.put("finish_tFileOutputDelimited_1", true);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"saida_Dim_Vendedor");
			  	}
 ...
 */
	...
	currentComponent="tSampleRow_1";
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"saida_Sample_vendedor");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final Dim_SalesPerson Dim_SalesPersonClass = new Dim_SalesPerson();

        int exitCode = Dim_SalesPersonClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_SalesPerson.class.getClassLoader().getResourceAsStream("adventure_project/dim_salesperson_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = Dim_SalesPerson.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : Dim_SalesPerson");
        }
...
/************************************************************************************************
 *     101924 characters generated by Talend Open Studio for Big Data 
 *     on the 13 de Julho de 2021 14h30min11s BRT
 ************************************************************************************************/