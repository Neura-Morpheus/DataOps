...
package adventure_project.salesorderheader_harm_0_1;
...
/**
 * Job: SalesOrderHeader_HARM Purpose: ETL area HARMONIZED<br>
 * Description: Carga de dados tabela SalesOrderHeader area HARMONIZED <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class SalesOrderHeader_HARM implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "SalesOrderHeader_HARM";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				SalesOrderHeader_HARM.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(SalesOrderHeader_HARM.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class saida_SalesOrderHeaderStruct implements routines.system.IPersistableRow<saida_SalesOrderHeaderStruct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_SalesOrderHeader_HARM = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_SalesOrderHeader_HARM = new byte[0];
	...
	public boolean equals(Object obj) {
		...
		final saida_SalesOrderHeaderStruct other = (saida_SalesOrderHeaderStruct) obj;
	...
	public void copyDataTo(saida_SalesOrderHeaderStruct other) {
	...
	public void copyKeysDataTo(saida_SalesOrderHeaderStruct other) {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADVENTURE_PROJECT_SalesOrderHeader_HARM.length) {
				if(length < 1024 && commonByteArray_ADVENTURE_PROJECT_SalesOrderHeader_HARM.length == 0) {
   					commonByteArray_ADVENTURE_PROJECT_SalesOrderHeader_HARM = new byte[1024];
				} else {
   					commonByteArray_ADVENTURE_PROJECT_SalesOrderHeader_HARM = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADVENTURE_PROJECT_SalesOrderHeader_HARM, 0, length);
			strReturn = new String(commonByteArray_ADVENTURE_PROJECT_SalesOrderHeader_HARM, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADVENTURE_PROJECT_SalesOrderHeader_HARM) {
     ...
     * Compare keys
     */
    public int compareTo(saida_SalesOrderHeaderStruct other) {
...
saida_SalesOrderHeaderStruct saida_SalesOrderHeader = new saida_SalesOrderHeaderStruct();
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"saida_SalesOrderHeader");
					}
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Repos/DataOps/Dados/HARMONIZED/SalesOrderHeader_HARM.csv")).getAbsolutePath().replace("\\","/");
...
saida_SalesOrderHeaderStruct saida_SalesOrderHeader_tmp = new saida_SalesOrderHeaderStruct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */"C:/Repos/DataOps/Dados/RAW/SalesOrderHeader.csv"/** End field tFileInputDelimited_1:FILENAME */;		
...
saida_SalesOrderHeader = null;


// # Output table : 'saida_SalesOrderHeader'
saida_SalesOrderHeader_tmp.SalesOrderID = row1.SalesOrderID;
saida_SalesOrderHeader_tmp.RevisionNumber = row1.RevisionNumber;
saida_SalesOrderHeader_tmp.OrderDate = row1.OrderDate;
saida_SalesOrderHeader_tmp.DueDate = row1.DueDate;
saida_SalesOrderHeader_tmp.ShipDate = row1.ShipDate;
saida_SalesOrderHeader_tmp.Status = row1.Status;
saida_SalesOrderHeader_tmp.OnlineOrderFlag = row1.OnlineOrderFlag;
saida_SalesOrderHeader_tmp.SalesOrderNumber = row1.SalesOrderNumber;
saida_SalesOrderHeader_tmp.PurchaseOrderNumber = row1.PurchaseOrderNumber;
saida_SalesOrderHeader_tmp.AccountNumber = row1.AccountNumber;
saida_SalesOrderHeader_tmp.CustomerID = row1.CustomerID;
saida_SalesOrderHeader_tmp.ShipToAddressID = row1.ShipToAddressID;
saida_SalesOrderHeader_tmp.BillToAddressID = row1.BillToAddressID;
saida_SalesOrderHeader_tmp.ShipMethod = row1.ShipMethod;
saida_SalesOrderHeader_tmp.CreditCardApprovalCode = row1.CreditCardApprovalCode;
saida_SalesOrderHeader_tmp.SubTotal = row1.SubTotal;
saida_SalesOrderHeader_tmp.TaxAmt = row1.TaxAmt;
saida_SalesOrderHeader_tmp.Freight = row1.Freight;
saida_SalesOrderHeader_tmp.TotalDue = row1.TotalDue;
saida_SalesOrderHeader_tmp.Comment = row1.Comment;
saida_SalesOrderHeader = saida_SalesOrderHeader_tmp;
// ###############################
 ...
 */
// Start of branch "saida_SalesOrderHeader"
if(saida_SalesOrderHeader != null) { 
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"saida_SalesOrderHeader");
					}
					


                        String[] rowtFileOutputDelimited_1=new String[20];
                            rowtFileOutputDelimited_1[0]=String.valueOf(saida_SalesOrderHeader.SalesOrderID);
                            rowtFileOutputDelimited_1[1]=saida_SalesOrderHeader.RevisionNumber == null ? null : String.valueOf(saida_SalesOrderHeader.RevisionNumber);
                            rowtFileOutputDelimited_1[2]=saida_SalesOrderHeader.OrderDate == null ? null : FormatterUtils.format_Date(saida_SalesOrderHeader.OrderDate, "dd-MM-yyyy");
                            rowtFileOutputDelimited_1[3]=saida_SalesOrderHeader.DueDate == null ? null : FormatterUtils.format_Date(saida_SalesOrderHeader.DueDate, "dd-MM-yyyy");
                            rowtFileOutputDelimited_1[4]=saida_SalesOrderHeader.ShipDate == null ? null : FormatterUtils.format_Date(saida_SalesOrderHeader.ShipDate, "dd-MM-yyyy");
                            rowtFileOutputDelimited_1[5]=saida_SalesOrderHeader.Status == null ? null : String.valueOf(saida_SalesOrderHeader.Status);
                            rowtFileOutputDelimited_1[6]=saida_SalesOrderHeader.OnlineOrderFlag == null ? null : String.valueOf(saida_SalesOrderHeader.OnlineOrderFlag);
                            rowtFileOutputDelimited_1[7]=saida_SalesOrderHeader.SalesOrderNumber == null ? null : saida_SalesOrderHeader.SalesOrderNumber;
                            rowtFileOutputDelimited_1[8]=saida_SalesOrderHeader.PurchaseOrderNumber == null ? null : saida_SalesOrderHeader.PurchaseOrderNumber;
                            rowtFileOutputDelimited_1[9]=saida_SalesOrderHeader.AccountNumber == null ? null : saida_SalesOrderHeader.AccountNumber;
                            rowtFileOutputDelimited_1[10]=saida_SalesOrderHeader.CustomerID == null ? null : String.valueOf(saida_SalesOrderHeader.CustomerID);
                            rowtFileOutputDelimited_1[11]=saida_SalesOrderHeader.ShipToAddressID == null ? null : String.valueOf(saida_SalesOrderHeader.ShipToAddressID);
                            rowtFileOutputDelimited_1[12]=saida_SalesOrderHeader.BillToAddressID == null ? null : String.valueOf(saida_SalesOrderHeader.BillToAddressID);
                            rowtFileOutputDelimited_1[13]=saida_SalesOrderHeader.ShipMethod == null ? null : saida_SalesOrderHeader.ShipMethod;
                            rowtFileOutputDelimited_1[14]=saida_SalesOrderHeader.CreditCardApprovalCode == null ? null : saida_SalesOrderHeader.CreditCardApprovalCode;
                            rowtFileOutputDelimited_1[15]=saida_SalesOrderHeader.SubTotal == null ? null : String.valueOf(saida_SalesOrderHeader.SubTotal);
                            rowtFileOutputDelimited_1[16]=saida_SalesOrderHeader.TaxAmt == null ? null : String.valueOf(saida_SalesOrderHeader.TaxAmt);
                            rowtFileOutputDelimited_1[17]=saida_SalesOrderHeader.Freight == null ? null : String.valueOf(saida_SalesOrderHeader.Freight);
                            rowtFileOutputDelimited_1[18]=saida_SalesOrderHeader.TotalDue == null ? null : String.valueOf(saida_SalesOrderHeader.TotalDue);
                            rowtFileOutputDelimited_1[19]=saida_SalesOrderHeader.Comment == null ? null : saida_SalesOrderHeader.Comment;
...
} // End of branch "saida_SalesOrderHeader"
 ...
 */
	...
	currentComponent="tFileOutputDelimited_1";
		...
		resourceMap.put("finish_tFileOutputDelimited_1", true);
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"saida_SalesOrderHeader");
			  	}
 ...
 */
    ...
    public static void main(String[] args){
        final SalesOrderHeader_HARM SalesOrderHeader_HARMClass = new SalesOrderHeader_HARM();

        int exitCode = SalesOrderHeader_HARMClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = SalesOrderHeader_HARM.class.getClassLoader().getResourceAsStream("adventure_project/salesorderheader_harm_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = SalesOrderHeader_HARM.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : SalesOrderHeader_HARM");
        }
...
/************************************************************************************************
 *     103818 characters generated by Talend Open Studio for Big Data 
 *     on the 13 de Julho de 2021 14h32min53s BRT
 ************************************************************************************************/