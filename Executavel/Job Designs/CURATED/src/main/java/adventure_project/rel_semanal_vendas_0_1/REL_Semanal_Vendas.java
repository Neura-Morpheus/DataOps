...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADVENTURE_PROJECT_REL_Semanal_Vendas.length) {
				if(length < 1024 && commonByteArray_ADVENTURE_PROJECT_REL_Semanal_Vendas.length == 0) {
   					commonByteArray_ADVENTURE_PROJECT_REL_Semanal_Vendas = new byte[1024];
				} else {
   					commonByteArray_ADVENTURE_PROJECT_REL_Semanal_Vendas = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADVENTURE_PROJECT_REL_Semanal_Vendas, 0, length);
			strReturn = new String(commonByteArray_ADVENTURE_PROJECT_REL_Semanal_Vendas, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Repos/DataOps/Dados/CURATED/Rel_Semanal_Vendas.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = REL_Semanal_Vendas.class.getClassLoader().getResourceAsStream("adventure_project/rel_semanal_vendas_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = REL_Semanal_Vendas.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : REL_Semanal_Vendas");
        }
