...
package adventure_project.rel_mensal_vendas_0_1;
...
/**
 * Job: REL_Mensal_Vendas Purpose: Relatorio de Vendas semanais<br>
 * Description: Dados agregados para relatório de negócios <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class REL_Mensal_Vendas implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "REL_Mensal_Vendas";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				REL_Mensal_Vendas.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(REL_Mensal_Vendas.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_REL_Mensal_Vendas = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_REL_Mensal_Vendas = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADVENTURE_PROJECT_REL_Mensal_Vendas.length) {
				if(length < 1024 && commonByteArray_ADVENTURE_PROJECT_REL_Mensal_Vendas.length == 0) {
   					commonByteArray_ADVENTURE_PROJECT_REL_Mensal_Vendas = new byte[1024];
				} else {
   					commonByteArray_ADVENTURE_PROJECT_REL_Mensal_Vendas = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADVENTURE_PROJECT_REL_Mensal_Vendas, 0, length);
			strReturn = new String(commonByteArray_ADVENTURE_PROJECT_REL_Mensal_Vendas, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADVENTURE_PROJECT_REL_Mensal_Vendas) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Repos/DataOps/Dados/CURATED/Rel_Mensal_Vendas.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
    ...
    public static void main(String[] args){
        final REL_Mensal_Vendas REL_Mensal_VendasClass = new REL_Mensal_Vendas();

        int exitCode = REL_Mensal_VendasClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = REL_Mensal_Vendas.class.getClassLoader().getResourceAsStream("adventure_project/rel_mensal_vendas_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = REL_Mensal_Vendas.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : REL_Mensal_Vendas");
        }
...
/************************************************************************************************
 *     274575 characters generated by Talend Open Studio for Big Data 
 *     on the 14 de Julho de 2021 0h35min47s BRT
 ************************************************************************************************/