		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				int result = DEFAULT_HASHCODE;
							...
							result = prime * result + ((this.RevisionNumber == null) ? 0 : this.RevisionNumber.hashCode());
							...
							result = prime * result + ((this.SalesOrderNumber == null) ? 0 : this.SalesOrderNumber.hashCode());
							
							result = prime * result + ((this.PurchaseOrderNumber == null) ? 0 : this.PurchaseOrderNumber.hashCode());
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */"C:/Repos/DataOps/Dados/HARMONIZED/SalesOrderHeader_HARM.csv"/** End field tFileInputDelimited_1:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.SalesOrderID = ParserUtils.parseTo_int(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									if(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1].length() > 0) {
										...
										row1.RevisionNumber = ParserUtils.parseTo_Short(rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1]);
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File("C:/Repos/DataOps/Dados/CURATED/SAMPLE_Order.csv")).getAbsolutePath().replace("\\","/");
            ...
            csvSettings_tFileOutputDelimited_2.setEscapeAndTextEnclosure("\"","\"");
                    ...
                    if(!csvSettings_tFileOutputDelimited_2.isUseCRLFRecordDelimiter() && csvSettings_tFileOutputDelimited_2.getRowDelim()!='\r' && csvSettings_tFileOutputDelimited_2.getRowDelim()!='\n') {
                        ...
                        if(filetFileOutputDelimited_2.length()==0){
                                    ...
                                    headColutFileOutputDelimited_2[1]="RevisionNumber";
                                    headColutFileOutputDelimited_2[2]="OrderDate";
                                    headColutFileOutputDelimited_2[3]="DueDate";
                                    headColutFileOutputDelimited_2[4]="ShipDate";
                                    headColutFileOutputDelimited_2[5]="Status";
                                    headColutFileOutputDelimited_2[6]="OnlineOrderFlag";
                                    headColutFileOutputDelimited_2[7]="SalesOrderNumber";
                                    headColutFileOutputDelimited_2[8]="PurchaseOrderNumber";
                                    headColutFileOutputDelimited_2[9]="AccountNumber";
                                    headColutFileOutputDelimited_2[10]="ShipToAddressID";
                                    headColutFileOutputDelimited_2[11]="BillToAddressID";
                                    headColutFileOutputDelimited_2[12]="ShipMethod";
                                    headColutFileOutputDelimited_2[13]="CustomerID";
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Repos/DataOps/Dados/CURATED/DIM_Order.csv")).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
            				    ...
            				    String s_RevisionNumber_RevisionNumber_tAggregateRow_1 = String.valueOf(aggregated_row_tAggregateRow_1.RevisionNumber);
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_1=new String[14];
                            ...
                            rowtFileOutputDelimited_1[1]=row2.RevisionNumber == null ? null : String.valueOf(row2.RevisionNumber);
                            rowtFileOutputDelimited_1[2]=row2.OrderDate == null ? null : FormatterUtils.format_Date(row2.OrderDate, "dd-MM-yyyy");
                            rowtFileOutputDelimited_1[3]=row2.DueDate == null ? null : FormatterUtils.format_Date(row2.DueDate, "dd-MM-yyyy");
                            rowtFileOutputDelimited_1[4]=row2.ShipDate == null ? null : FormatterUtils.format_Date(row2.ShipDate, "dd-MM-yyyy");
                            rowtFileOutputDelimited_1[5]=row2.Status == null ? null : String.valueOf(row2.Status);
                            rowtFileOutputDelimited_1[6]=row2.OnlineOrderFlag == null ? null : String.valueOf(row2.OnlineOrderFlag);
                            ...
                            rowtFileOutputDelimited_1[10]=row2.ShipToAddressID == null ? null : String.valueOf(row2.ShipToAddressID);
                            rowtFileOutputDelimited_1[11]=row2.BillToAddressID == null ? null : String.valueOf(row2.BillToAddressID);
 ...
 */
	...
	nb_line_tSampleRow_1++;
 	...
 	if(!rangeSettSampleRow_1.contains(nb_line_tSampleRow_1)){        
       ...
       row4.SalesOrderID = row3.SalesOrderID;
       

       row4.RevisionNumber = row3.RevisionNumber;
       

       row4.OrderDate = row3.OrderDate;
       

       row4.DueDate = row3.DueDate;
       

       row4.ShipDate = row3.ShipDate;
       

       row4.Status = row3.Status;
       

       row4.OnlineOrderFlag = row3.OnlineOrderFlag;
       

       row4.SalesOrderNumber = row3.SalesOrderNumber;
       

       row4.PurchaseOrderNumber = row3.PurchaseOrderNumber;
       

       row4.AccountNumber = row3.AccountNumber;
       

       row4.ShipToAddressID = row3.ShipToAddressID;
       

       row4.BillToAddressID = row3.BillToAddressID;
       

       row4.ShipMethod = row3.ShipMethod;
	...
	currentComponent="tFileOutputDelimited_2";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_2=new String[14];
                            rowtFileOutputDelimited_2[0]=row4.SalesOrderID == null ? null : String.valueOf(row4.SalesOrderID);
                            rowtFileOutputDelimited_2[1]=row4.RevisionNumber == null ? null : String.valueOf(row4.RevisionNumber);
                            rowtFileOutputDelimited_2[2]=row4.OrderDate == null ? null : FormatterUtils.format_Date(row4.OrderDate, "dd-MM-yyyy");
                            rowtFileOutputDelimited_2[3]=row4.DueDate == null ? null : FormatterUtils.format_Date(row4.DueDate, "dd-MM-yyyy");
                            rowtFileOutputDelimited_2[4]=row4.ShipDate == null ? null : FormatterUtils.format_Date(row4.ShipDate, "dd-MM-yyyy");
                            rowtFileOutputDelimited_2[5]=row4.Status == null ? null : String.valueOf(row4.Status);
                            rowtFileOutputDelimited_2[6]=row4.OnlineOrderFlag == null ? null : String.valueOf(row4.OnlineOrderFlag);
                            rowtFileOutputDelimited_2[7]=row4.SalesOrderNumber == null ? null : row4.SalesOrderNumber;
                            rowtFileOutputDelimited_2[8]=row4.PurchaseOrderNumber == null ? null : row4.PurchaseOrderNumber;
                            rowtFileOutputDelimited_2[9]=row4.AccountNumber == null ? null : row4.AccountNumber;
                            rowtFileOutputDelimited_2[10]=row4.ShipToAddressID == null ? null : String.valueOf(row4.ShipToAddressID);
                            rowtFileOutputDelimited_2[11]=row4.BillToAddressID == null ? null : String.valueOf(row4.BillToAddressID);
                            rowtFileOutputDelimited_2[12]=row4.ShipMethod == null ? null : row4.ShipMethod;
                            rowtFileOutputDelimited_2[13]=row4.CustomerID == null ? null : String.valueOf(row4.CustomerID);
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = DIM_Order.class.getClassLoader().getResourceAsStream("adventure_project/dim_order_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = DIM_Order.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
/************************************************************************************************
 *     173027 characters generated by Talend Open Studio for Big Data 
