...
package adventure_project.rel_diario_vendas_0_1;
...
/**
 * Job: REL_Diario_Vendas Purpose: Relatorio de Vendas semanais<br>
 * Description: Dados agregados para relatório de negócios <br>
 * @author user@talend.com
 * @version 7.3.1.20200219_1130
 * @status 
 */
public class REL_Diario_Vendas implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "REL_Diario_Vendas";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				REL_Diario_Vendas.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(REL_Diario_Vendas.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row7Struct implements routines.system.IPersistableRow<row7Struct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_REL_Diario_Vendas = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_REL_Diario_Vendas = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADVENTURE_PROJECT_REL_Diario_Vendas.length) {
				if(length < 1024 && commonByteArray_ADVENTURE_PROJECT_REL_Diario_Vendas.length == 0) {
   					commonByteArray_ADVENTURE_PROJECT_REL_Diario_Vendas = new byte[1024];
				} else {
   					commonByteArray_ADVENTURE_PROJECT_REL_Diario_Vendas = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADVENTURE_PROJECT_REL_Diario_Vendas, 0, length);
			strReturn = new String(commonByteArray_ADVENTURE_PROJECT_REL_Diario_Vendas, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADVENTURE_PROJECT_REL_Diario_Vendas) {
...
// ------------
	...
	class AggOperationStruct_tAggregateRow_1 { // G_OutBegin_AggR_100
	    ...
	    public boolean hashCodeDirty = true;
    				...
    				String SalesPerson;
    				java.util.Date OrderDate;BigDecimal ValorVenda_sum;
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Repos/DataOps/Dados/CURATED/Rel_Diario_Vendas.csv")).getAbsolutePath().replace("\\","/");
	...
	currentComponent="tFileOutputDelimited_1";
                    ...
                    StringBuilder sb_tFileOutputDelimited_1 = new StringBuilder();
                        ...
                        sb_tFileOutputDelimited_1.append(
                            ...
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.CountryRegion != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.CountryRegion
                        );
                            }
                            sb_tFileOutputDelimited_1.append(OUT_DELIM_tFileOutputDelimited_1);
                            if(row7.ValorVenda != null) {
                        sb_tFileOutputDelimited_1.append(
                            row7.ValorVenda
                        );
                            }
 ...
 */
    ...
    public static void main(String[] args){
        final REL_Diario_Vendas REL_Diario_VendasClass = new REL_Diario_Vendas();

        int exitCode = REL_Diario_VendasClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = REL_Diario_Vendas.class.getClassLoader().getResourceAsStream("adventure_project/rel_diario_vendas_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = REL_Diario_Vendas.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : REL_Diario_Vendas");
        }
...
/************************************************************************************************
 *     278619 characters generated by Talend Open Studio for Big Data 
 *     on the 14 de Julho de 2021 0h35min46s BRT
 ************************************************************************************************/