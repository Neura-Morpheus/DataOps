...
package adventure_project.dim_customer_0_1;
...
/**
 * Job: Dim_Customer Purpose: Entidade Cliente<br>
 * Description:  <br>
...
public static class row6Struct implements routines.system.IPersistableRow<row6Struct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_Dim_Customer = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_Dim_Customer = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_ADVENTURE_PROJECT_Dim_Customer.length) {
				if(length < 1024 && commonByteArray_ADVENTURE_PROJECT_Dim_Customer.length == 0) {
   					commonByteArray_ADVENTURE_PROJECT_Dim_Customer = new byte[1024];
				} else {
   					commonByteArray_ADVENTURE_PROJECT_Dim_Customer = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_ADVENTURE_PROJECT_Dim_Customer, 0, length);
			strReturn = new String(commonByteArray_ADVENTURE_PROJECT_Dim_Customer, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_ADVENTURE_PROJECT_Dim_Customer) {
...
public static class saida_Dim_CustomerStruct implements routines.system.IPersistableRow<saida_Dim_CustomerStruct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_Dim_Customer = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_Dim_Customer = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final saida_Dim_CustomerStruct other = (saida_Dim_CustomerStruct) obj;
	...
	public void copyDataTo(saida_Dim_CustomerStruct other) {
	...
	public void copyKeysDataTo(saida_Dim_CustomerStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(saida_Dim_CustomerStruct other) {
...
public static class saida_SAMPLE_ClienteStruct implements routines.system.IPersistableRow<saida_SAMPLE_ClienteStruct> {
    final static byte[] commonByteArrayLock_ADVENTURE_PROJECT_Dim_Customer = new byte[0];
    static byte[] commonByteArray_ADVENTURE_PROJECT_Dim_Customer = new byte[0];
	protected static final int DEFAULT_HASHCODE = 1;
    protected static final int PRIME = 31;
	...
	public boolean equals(Object obj) {
		...
		if (obj == null) return false;
		if (getClass() != obj.getClass()) return false;
		final saida_SAMPLE_ClienteStruct other = (saida_SAMPLE_ClienteStruct) obj;
	...
	public void copyDataTo(saida_SAMPLE_ClienteStruct other) {
	...
	public void copyKeysDataTo(saida_SAMPLE_ClienteStruct other) {
     ...
     * Compare keys
     */
    public int compareTo(saida_SAMPLE_ClienteStruct other) {
...
saida_Dim_CustomerStruct saida_Dim_Customer = new saida_Dim_CustomerStruct();
row3Struct row3 = new row3Struct();
saida_SAMPLE_ClienteStruct saida_SAMPLE_Cliente = new saida_SAMPLE_ClienteStruct();
...
row6Struct row6 = new row6Struct();
	...
	currentComponent="tAggregateRow_1_AGGOUT";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"saida_Dim_Customer");
					}
		...
		public int hashCode() {
			if (this.hashCodeDirty) {
				...
				int result = DEFAULT_HASHCODE;
							...
							result = prime * result + ((this.NameStyle == null) ? 0 : this.NameStyle.hashCode());
 ...
 */
	...
	currentComponent="tAggregateRow_2_AGGOUT";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"saida_SAMPLE_Cliente");
					}
...
saida_Dim_CustomerStruct saida_Dim_Customer_tmp = new saida_Dim_CustomerStruct();
saida_SAMPLE_ClienteStruct saida_SAMPLE_Cliente_tmp = new saida_SAMPLE_ClienteStruct();
// ###############################
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_1 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_1 = /** Start field tFileInputDelimited_1:FILENAME */"C:/Repos/DataOps/Dados/HARMONIZED/Customer_HARM.csv"/** End field tFileInputDelimited_1:FILENAME */;		
				...
				if(rowtFileInputDelimited_1.length == 1 && ("\015").equals(rowtFileInputDelimited_1[0])){//empty line when row separator is '\n'
	                ...
	                int columnIndexWithD_tFileInputDelimited_1 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.NameStyle = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
						...
						if(columnIndexWithD_tFileInputDelimited_1 < rowtFileInputDelimited_1.length){
									...
									row1.MiddleName = rowtFileInputDelimited_1[columnIndexWithD_tFileInputDelimited_1];
...
Var.FullName = StringHandling.TRIM(row1.FirstName)+" "+StringHandling.TRIM(row1.MiddleName)+" "+StringHandling.TRIM(row1.LastName)+"  "+StringHandling.TRIM(row1.Suffix) ;// ###############################
        // ###############################
        // # Output tables

saida_Dim_Customer = null;
saida_SAMPLE_Cliente = null;


// # Output table : 'saida_Dim_Customer'
saida_Dim_Customer_tmp.CustomerID = row1.CustomerID ;
saida_Dim_Customer_tmp.AddressID = Relational.ISNULL(row4.AddressID)?0:row4.AddressID ;
saida_Dim_Customer_tmp.NameStyle = row1.NameStyle ;
saida_Dim_Customer_tmp.Title = row1.Title ;
saida_Dim_Customer_tmp.FullName = Var.FullName ;
saida_Dim_Customer_tmp.CompanyName = row1.CompanyName ;
saida_Dim_Customer_tmp.SalesPerson = row1.SalesPerson ;
saida_Dim_Customer_tmp.EmailAddress = row1.EmailAddress ;
saida_Dim_Customer_tmp.Phone = row1.Phone ;
saida_Dim_Customer_tmp.AddressType = row4.AddressType ;
saida_Dim_Customer_tmp.AddressLine1 = row4.AddressLine1 ;
saida_Dim_Customer_tmp.AddressLine2 = row4.AddressLine2 ;
saida_Dim_Customer_tmp.City = row4.City ;
saida_Dim_Customer_tmp.StateProvince = row4.StateProvince ;
saida_Dim_Customer_tmp.CountryRegion = row4.CountryRegion ;
saida_Dim_Customer_tmp.PostalCode = row4.PostalCode ;
saida_Dim_Customer = saida_Dim_Customer_tmp;

// # Output table : 'saida_SAMPLE_Cliente'
saida_SAMPLE_Cliente_tmp.CustomerID = row1.CustomerID ;
saida_SAMPLE_Cliente_tmp.AddressID = Relational.ISNULL(row4.AddressID)?0:row4.AddressID ;
saida_SAMPLE_Cliente_tmp.NameStyle = row1.NameStyle ;
saida_SAMPLE_Cliente_tmp.Title = row1.Title ;
saida_SAMPLE_Cliente_tmp.FullName = Var.FullName ;
saida_SAMPLE_Cliente_tmp.CompanyName = row1.CompanyName ;
saida_SAMPLE_Cliente_tmp.SalesPerson = row1.SalesPerson ;
saida_SAMPLE_Cliente_tmp.EmailAddress = row1.EmailAddress ;
saida_SAMPLE_Cliente_tmp.Phone = row1.Phone ;
saida_SAMPLE_Cliente_tmp.AddressType = row4.AddressType ;
saida_SAMPLE_Cliente_tmp.AddressLine1 = row4.AddressLine1 ;
saida_SAMPLE_Cliente_tmp.AddressLine2 = row4.AddressLine2 ;
saida_SAMPLE_Cliente_tmp.City = row4.City ;
saida_SAMPLE_Cliente_tmp.StateProvince = row4.StateProvince ;
saida_SAMPLE_Cliente_tmp.CountryRegion = row4.CountryRegion ;
saida_SAMPLE_Cliente_tmp.PostalCode = row4.PostalCode ;
saida_SAMPLE_Cliente = saida_SAMPLE_Cliente_tmp;
// ###############################
 ...
 */
// Start of branch "saida_Dim_Customer"
if(saida_Dim_Customer != null) { 
	...
	currentComponent="tAggregateRow_1_AGGOUT";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"saida_Dim_Customer");
					}
					
	
operation_finder_tAggregateRow_1.CustomerID = saida_Dim_Customer.CustomerID;
			operation_finder_tAggregateRow_1.AddressID = saida_Dim_Customer.AddressID;
			operation_finder_tAggregateRow_1.NameStyle = saida_Dim_Customer.NameStyle;
			operation_finder_tAggregateRow_1.Title = saida_Dim_Customer.Title;
			operation_finder_tAggregateRow_1.FullName = saida_Dim_Customer.FullName;
			operation_finder_tAggregateRow_1.CompanyName = saida_Dim_Customer.CompanyName;
			operation_finder_tAggregateRow_1.SalesPerson = saida_Dim_Customer.SalesPerson;
			operation_finder_tAggregateRow_1.EmailAddress = saida_Dim_Customer.EmailAddress;
			operation_finder_tAggregateRow_1.Phone = saida_Dim_Customer.Phone;
			operation_finder_tAggregateRow_1.AddressType = saida_Dim_Customer.AddressType;
			operation_finder_tAggregateRow_1.AddressLine1 = saida_Dim_Customer.AddressLine1;
			operation_finder_tAggregateRow_1.AddressLine2 = saida_Dim_Customer.AddressLine2;
			operation_finder_tAggregateRow_1.City = saida_Dim_Customer.City;
			operation_finder_tAggregateRow_1.StateProvince = saida_Dim_Customer.StateProvince;
			operation_finder_tAggregateRow_1.CountryRegion = saida_Dim_Customer.CountryRegion;
			operation_finder_tAggregateRow_1.PostalCode = saida_Dim_Customer.PostalCode;
	...
	if(operation_result_tAggregateRow_1 == null) { // G_OutMain_AggR_001
		...
		operation_result_tAggregateRow_1.CustomerID = operation_finder_tAggregateRow_1.CustomerID;
				...
				operation_result_tAggregateRow_1.NameStyle = operation_finder_tAggregateRow_1.NameStyle;
				operation_result_tAggregateRow_1.Title = operation_finder_tAggregateRow_1.Title;
				operation_result_tAggregateRow_1.FullName = operation_finder_tAggregateRow_1.FullName;
				...
				operation_result_tAggregateRow_1.EmailAddress = operation_finder_tAggregateRow_1.EmailAddress;
				operation_result_tAggregateRow_1.Phone = operation_finder_tAggregateRow_1.Phone;
...
} // End of branch "saida_Dim_Customer"




// Start of branch "saida_SAMPLE_Cliente"
if(saida_SAMPLE_Cliente != null) { 
	...
	currentComponent="tAggregateRow_2_AGGOUT";
					...
					if(execStat){
						runStat.updateStatOnConnection(iterateId,1,1,"saida_SAMPLE_Cliente");
					}
					
	
operation_finder_tAggregateRow_2.CustomerID = saida_SAMPLE_Cliente.CustomerID;
			operation_finder_tAggregateRow_2.AddressID = saida_SAMPLE_Cliente.AddressID;
			operation_finder_tAggregateRow_2.NameStyle = saida_SAMPLE_Cliente.NameStyle;
			operation_finder_tAggregateRow_2.Title = saida_SAMPLE_Cliente.Title;
			operation_finder_tAggregateRow_2.FullName = saida_SAMPLE_Cliente.FullName;
			operation_finder_tAggregateRow_2.CompanyName = saida_SAMPLE_Cliente.CompanyName;
			operation_finder_tAggregateRow_2.SalesPerson = saida_SAMPLE_Cliente.SalesPerson;
			operation_finder_tAggregateRow_2.EmailAddress = saida_SAMPLE_Cliente.EmailAddress;
			operation_finder_tAggregateRow_2.Phone = saida_SAMPLE_Cliente.Phone;
			operation_finder_tAggregateRow_2.AddressType = saida_SAMPLE_Cliente.AddressType;
			operation_finder_tAggregateRow_2.AddressLine1 = saida_SAMPLE_Cliente.AddressLine1;
			operation_finder_tAggregateRow_2.AddressLine2 = saida_SAMPLE_Cliente.AddressLine2;
			operation_finder_tAggregateRow_2.City = saida_SAMPLE_Cliente.City;
			operation_finder_tAggregateRow_2.StateProvince = saida_SAMPLE_Cliente.StateProvince;
			operation_finder_tAggregateRow_2.CountryRegion = saida_SAMPLE_Cliente.CountryRegion;
			operation_finder_tAggregateRow_2.PostalCode = saida_SAMPLE_Cliente.PostalCode;
	...
	if(operation_result_tAggregateRow_2 == null) { // G_OutMain_AggR_001
		...
		operation_result_tAggregateRow_2.CustomerID = operation_finder_tAggregateRow_2.CustomerID;
				operation_result_tAggregateRow_2.AddressID = operation_finder_tAggregateRow_2.AddressID;
				operation_result_tAggregateRow_2.NameStyle = operation_finder_tAggregateRow_2.NameStyle;
				operation_result_tAggregateRow_2.Title = operation_finder_tAggregateRow_2.Title;
				operation_result_tAggregateRow_2.FullName = operation_finder_tAggregateRow_2.FullName;
				...
				operation_result_tAggregateRow_2.EmailAddress = operation_finder_tAggregateRow_2.EmailAddress;
				operation_result_tAggregateRow_2.Phone = operation_finder_tAggregateRow_2.Phone;
				operation_result_tAggregateRow_2.AddressType = operation_finder_tAggregateRow_2.AddressType;
				operation_result_tAggregateRow_2.AddressLine1 = operation_finder_tAggregateRow_2.AddressLine1;
				operation_result_tAggregateRow_2.AddressLine2 = operation_finder_tAggregateRow_2.AddressLine2;
				...
				operation_result_tAggregateRow_2.PostalCode = operation_finder_tAggregateRow_2.PostalCode;
...
} // End of branch "saida_SAMPLE_Cliente"
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGOUT";
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"saida_Dim_Customer");
			  	}
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File("C:/Repos/DataOps/Dados/CURATED/DIM_Cliente.csv")).getAbsolutePath().replace("\\","/");
            ...
            csvSettings_tFileOutputDelimited_1.setEscapeAndTextEnclosure("\"","\"");
                    ...
                    if(!csvSettings_tFileOutputDelimited_1.isUseCRLFRecordDelimiter() && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\r' && csvSettings_tFileOutputDelimited_1.getRowDelim()!='\n') {
                        ...
                        if(filetFileOutputDelimited_1.length()==0){
                                    ...
                                    headColutFileOutputDelimited_1[2]="NameStyle";
                                    headColutFileOutputDelimited_1[3]="Title";
                                    headColutFileOutputDelimited_1[4]="FullName";
                                    headColutFileOutputDelimited_1[5]="CompanyName";
                                    headColutFileOutputDelimited_1[6]="SalesPerson";
                                    headColutFileOutputDelimited_1[7]="EmailAddress";
                                    headColutFileOutputDelimited_1[8]="Phone";
                                    headColutFileOutputDelimited_1[9]="AddressType";
                                    headColutFileOutputDelimited_1[10]="AddressLine1";
                                    headColutFileOutputDelimited_1[11]="AddressLine2";
                                    headColutFileOutputDelimited_1[12]="City";
                                    headColutFileOutputDelimited_1[13]="StateProvince";
                                    headColutFileOutputDelimited_1[14]="CountryRegion";
                                    headColutFileOutputDelimited_1[15]="PostalCode";
 ...
 */
	...
	currentComponent="tAggregateRow_1_AGGIN";
            				    ...
            				    row3.NameStyle = aggregated_row_tAggregateRow_1.NameStyle;
            				    
            				    row3.Title = aggregated_row_tAggregateRow_1.Title;
            				    
            				    row3.FullName = aggregated_row_tAggregateRow_1.FullName;
            				    
            				    row3.CompanyName = aggregated_row_tAggregateRow_1.CompanyName;
            				    
            				    row3.SalesPerson = aggregated_row_tAggregateRow_1.SalesPerson;
            				    
            				    row3.EmailAddress = aggregated_row_tAggregateRow_1.EmailAddress;
            				    
            				    row3.Phone = aggregated_row_tAggregateRow_1.Phone;
	...
	currentComponent="tFileOutputDelimited_1";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_1=new String[16];
                            ...
                            rowtFileOutputDelimited_1[2]=row3.NameStyle == null ? null : row3.NameStyle;
                            rowtFileOutputDelimited_1[3]=row3.Title == null ? null : row3.Title;
                            rowtFileOutputDelimited_1[4]=row3.FullName == null ? null : row3.FullName;
                            rowtFileOutputDelimited_1[5]=row3.CompanyName == null ? null : row3.CompanyName;
                            rowtFileOutputDelimited_1[6]=row3.SalesPerson == null ? null : row3.SalesPerson;
                            rowtFileOutputDelimited_1[7]=row3.EmailAddress == null ? null : row3.EmailAddress;
                            rowtFileOutputDelimited_1[8]=row3.Phone == null ? null : row3.Phone;
                            rowtFileOutputDelimited_1[9]=row3.AddressType == null ? null : row3.AddressType;
                            rowtFileOutputDelimited_1[10]=row3.AddressLine1 == null ? null : row3.AddressLine1;
                            rowtFileOutputDelimited_1[11]=row3.AddressLine2 == null ? null : row3.AddressLine2;
                            rowtFileOutputDelimited_1[12]=row3.City == null ? null : row3.City;
                            rowtFileOutputDelimited_1[13]=row3.StateProvince == null ? null : row3.StateProvince;
                            rowtFileOutputDelimited_1[14]=row3.CountryRegion == null ? null : row3.CountryRegion;
                            rowtFileOutputDelimited_1[15]=row3.PostalCode == null ? null : row3.PostalCode;
 ...
 */
	...
	currentComponent="tAggregateRow_2_AGGOUT";
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"saida_SAMPLE_Cliente");
			  	}
...
String fileName_tFileOutputDelimited_2 = "";
    fileName_tFileOutputDelimited_2 = (new java.io.File("C:/Repos/DataOps/Dados/CURATED/SAMPLE_Cliente.csv")).getAbsolutePath().replace("\\","/");
    ...
    globalMap.put("tFileOutputDelimited_2_FILE_NAME",fileName_tFileOutputDelimited_2);
                String[] headColutFileOutputDelimited_2=new String[16];
            ...
            csvSettings_tFileOutputDelimited_2.setEscapeAndTextEnclosure("\"","\"");
                    ...
                    if(!csvSettings_tFileOutputDelimited_2.isUseCRLFRecordDelimiter() && csvSettings_tFileOutputDelimited_2.getRowDelim()!='\r' && csvSettings_tFileOutputDelimited_2.getRowDelim()!='\n') {
                        ...
                        if(filetFileOutputDelimited_2.length()==0){
                                    headColutFileOutputDelimited_2[0]="CustomerID";
                                    headColutFileOutputDelimited_2[1]="AddressID";
                                    headColutFileOutputDelimited_2[2]="NameStyle";
                                    headColutFileOutputDelimited_2[3]="Title";
                                    headColutFileOutputDelimited_2[4]="FullName";
                                    headColutFileOutputDelimited_2[5]="CompanyName";
                                    headColutFileOutputDelimited_2[6]="SalesPerson";
                                    headColutFileOutputDelimited_2[7]="EmailAddress";
                                    headColutFileOutputDelimited_2[8]="Phone";
                                    headColutFileOutputDelimited_2[9]="AddressType";
                                    headColutFileOutputDelimited_2[10]="AddressLine1";
                                    headColutFileOutputDelimited_2[11]="AddressLine2";
                                    headColutFileOutputDelimited_2[12]="City";
                                    headColutFileOutputDelimited_2[13]="StateProvince";
                                    headColutFileOutputDelimited_2[14]="CountryRegion";
                                    headColutFileOutputDelimited_2[15]="PostalCode";
 ...
 */
	...
	currentComponent="tAggregateRow_2_AGGIN";
            				    ...
            				    row5.CustomerID = aggregated_row_tAggregateRow_2.CustomerID;
            				    
            				    row5.AddressID = aggregated_row_tAggregateRow_2.AddressID;
            				    
            				    row5.NameStyle = aggregated_row_tAggregateRow_2.NameStyle;
            				    
            				    row5.Title = aggregated_row_tAggregateRow_2.Title;
            				    
            				    row5.FullName = aggregated_row_tAggregateRow_2.FullName;
            				    
            				    row5.CompanyName = aggregated_row_tAggregateRow_2.CompanyName;
            				    
            				    row5.SalesPerson = aggregated_row_tAggregateRow_2.SalesPerson;
            				    
            				    row5.EmailAddress = aggregated_row_tAggregateRow_2.EmailAddress;
            				    
            				    row5.Phone = aggregated_row_tAggregateRow_2.Phone;
            				    
            				    row5.AddressType = aggregated_row_tAggregateRow_2.AddressType;
            				    
            				    row5.AddressLine1 = aggregated_row_tAggregateRow_2.AddressLine1;
            				    
            				    row5.AddressLine2 = aggregated_row_tAggregateRow_2.AddressLine2;
            				    
            				    row5.City = aggregated_row_tAggregateRow_2.City;
            				    
            				    row5.StateProvince = aggregated_row_tAggregateRow_2.StateProvince;
            				    
            				    row5.CountryRegion = aggregated_row_tAggregateRow_2.CountryRegion;
            				    
            				    row5.PostalCode = aggregated_row_tAggregateRow_2.PostalCode;
 ...
 */
	...
	nb_line_tSampleRow_1++;
 	...
 	if(!rangeSettSampleRow_1.contains(nb_line_tSampleRow_1)){        
       ...
       row6.AddressID = row5.AddressID;
       

       row6.NameStyle = row5.NameStyle;
       

       row6.Title = row5.Title;
       

       row6.FullName = row5.FullName;
       

       row6.CompanyName = row5.CompanyName;
       

       row6.SalesPerson = row5.SalesPerson;
       

       row6.EmailAddress = row5.EmailAddress;
       

       row6.Phone = row5.Phone;
       

       row6.AddressType = row5.AddressType;
       

       row6.AddressLine1 = row5.AddressLine1;
       

       row6.AddressLine2 = row5.AddressLine2;
       

       row6.City = row5.City;
       

       row6.StateProvince = row5.StateProvince;
       

       row6.CountryRegion = row5.CountryRegion;
       

       row6.PostalCode = row5.PostalCode;
...
if(row6 != null) { 
	...
	currentComponent="tFileOutputDelimited_2";
					...
					if(execStat){
                        ...
                        String[] rowtFileOutputDelimited_2=new String[16];
                            rowtFileOutputDelimited_2[0]=row6.CustomerID == null ? null : String.valueOf(row6.CustomerID);
                            rowtFileOutputDelimited_2[1]=row6.AddressID == null ? null : String.valueOf(row6.AddressID);
                            rowtFileOutputDelimited_2[2]=row6.NameStyle == null ? null : row6.NameStyle;
                            rowtFileOutputDelimited_2[3]=row6.Title == null ? null : row6.Title;
                            rowtFileOutputDelimited_2[4]=row6.FullName == null ? null : row6.FullName;
                            rowtFileOutputDelimited_2[5]=row6.CompanyName == null ? null : row6.CompanyName;
                            rowtFileOutputDelimited_2[6]=row6.SalesPerson == null ? null : row6.SalesPerson;
                            rowtFileOutputDelimited_2[7]=row6.EmailAddress == null ? null : row6.EmailAddress;
                            rowtFileOutputDelimited_2[8]=row6.Phone == null ? null : row6.Phone;
                            rowtFileOutputDelimited_2[9]=row6.AddressType == null ? null : row6.AddressType;
                            rowtFileOutputDelimited_2[10]=row6.AddressLine1 == null ? null : row6.AddressLine1;
                            rowtFileOutputDelimited_2[11]=row6.AddressLine2 == null ? null : row6.AddressLine2;
                            rowtFileOutputDelimited_2[12]=row6.City == null ? null : row6.City;
                            rowtFileOutputDelimited_2[13]=row6.StateProvince == null ? null : row6.StateProvince;
                            rowtFileOutputDelimited_2[14]=row6.CountryRegion == null ? null : row6.CountryRegion;
                            rowtFileOutputDelimited_2[15]=row6.PostalCode == null ? null : row6.PostalCode;
...
row4Struct row4 = new row4Struct();
	...
	currentComponent="tAdvancedHash_row4";
		...
		int tos_count_tAdvancedHash_row4 = 0;
			   		...
			   		// source node:tFilterRow_1 - inputs:(row2) outputs:(row4,row4) | target node:tAdvancedHash_row4 - inputs:(row4) outputs:()
			   		// linked node: tMap_1 - inputs:(row1,row4) outputs:(saida_Dim_Customer,saida_SAMPLE_Cliente)
 ...
 */
	...
	final routines.system.RowState rowstate_tFileInputDelimited_2 = new routines.system.RowState();
				...
				Object filename_tFileInputDelimited_2 = /** Start field tFileInputDelimited_2:FILENAME */"C:/Repos/DataOps/Dados/HARMONIZED/CustomerAddress_HARM.csv"/** End field tFileInputDelimited_2:FILENAME */;		
	                ...
	                int columnIndexWithD_tFileInputDelimited_2 = 0; //Column Index 
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row2.CustomerID = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
											...
											rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"CustomerID", "row2", rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									if(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2].length() > 0) {
										...
										row2.AddressID = ParserUtils.parseTo_Integer(rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2]);
									
									
										} catch(java.lang.Exception ex_tFileInputDelimited_2) {
											rowstate_tFileInputDelimited_2.setException(new RuntimeException(String.format("Couldn't parse value for column '%s' in '%s', value is '%s'. Details: %s",
												"AddressID", "row2", rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2], ex_tFileInputDelimited_2), ex_tFileInputDelimited_2));
										}
    								}else{
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row2.AddressType = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row2.StateProvince = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
						...
						if(columnIndexWithD_tFileInputDelimited_2 < rowtFileInputDelimited_2.length){
									...
									row2.CountryRegion = rowtFileInputDelimited_2[columnIndexWithD_tFileInputDelimited_2];
...
if(row2 != null) { 
    ...
    Operator_tFilterRow_1 ope_tFilterRow_1 = new Operator_tFilterRow_1("&&");    
        ope_tFilterRow_1.matches((row2.AddressType == null? false : row2.AddressType.matches("Main Office") == true)
                       , " AddressType.matches(\"Main Office\") == true failed");
    ...
    if (ope_tFilterRow_1.getMatchFlag()) {
              if(row4 == null){ 
               ...
               row4.AddressID = row2.AddressID;
               row4.AddressType = row2.AddressType;
               row4.AddressLine1 = row2.AddressLine1;
               row4.AddressLine2 = row2.AddressLine2;
               row4.City = row2.City;
               row4.StateProvince = row2.StateProvince;
               row4.CountryRegion = row2.CountryRegion;
 ...
 */
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = Dim_Customer.class.getClassLoader().getResourceAsStream("adventure_project/dim_customer_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
...
/************************************************************************************************
 *     247176 characters generated by Talend Open Studio for Big Data 
 *     on the 13 de Julho de 2021 14h29min27s BRT
 ************************************************************************************************/